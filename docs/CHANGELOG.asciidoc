...
* Add the ability to compute SHAP values (SHapley Additive exPlanation) for feature importance by
specifying the parameter `top_shap_values`. (See {ml-pull}857[#857].)
