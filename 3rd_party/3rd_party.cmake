...
elseif ("${HOST_SYSTEM_NAME}" STREQUAL "linux")
  ...
  file(GLOB REDIST_DIRS "${VCBASE}/VC/Redist/MSVC/${VCVER}/x64/*")
  message(STATUS "REDIST_DIRS = ${REDIST_DIRS}")
  set(OMP_LOCATION "${VCBASE}/VC/Redist/MSVC/${VCVER}/x64/Microsoft.VC142.OpenMP")
  message(STATUS "OMP_LOCATION = ${OMP_LOCATION}")
  file(GLOB OMP_FILES "${OMP_LOCATION}/*")
  message(STATUS "OMP_FILES = ${OMP_FILES}")
