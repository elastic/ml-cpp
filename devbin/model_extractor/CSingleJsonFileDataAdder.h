 ...
 */
#ifndef INCLUDED_ml_modelextractor_CSingleJsonFileDataAdder_h
#define INCLUDED_ml_modelextractor_CSingleJsonFileDataAdder_h
...
//!
class  CSingleJsonFileDataAdder : public core::CDataAdder {
public:
...
public:
    ...
    CSingleJsonFileDataAdder(std::string baseFilename, std::string fileExtension = JSON_FILE_EXT);
...
#endif // INCLUDED_ml_modelextractor_CSingleJsonFileDataAdder_h
