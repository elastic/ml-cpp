...
#===================================
    ...
    print <<"ASCIIDOC";
:ml-issue: https://github.com/${User_Repo}issues/
:ml-pull:  https://github.com/${User_Repo}pull/
    ...
    for my $group ( @Groups, 'other' ) {
        ...
        for my $header ( sort keys %$group_issues ) {
            ...
            for my $issue (@$header_issues) {
                ...
                print encode_utf8("* $title {ml-pull}${number}[#${number}]");
