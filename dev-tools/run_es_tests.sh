...
sed -i 's/private static final int ES_DESTROY_TIMEOUT = 20/private static final int ES_DESTROY_TIMEOUT = 60/' ./build-tools/src/main/java/org/elasticsearch/gradle/testclusters/ElasticsearchNode.java"
IVY_REPO_URL="file://$2"
