...
public:
public:
    explicit CThreadSettings(std::int64_t maxThreads,
                             std::int64_t numThreadsPerAllocation,
                             std::int64_t numAllocations);

    std::int64_t numThreadsPerAllocation() const;
    std::int64_t numAllocations() const;
    ...
    void numAllocations(std::int64_t numAllocations);
    ...
    //! allocations.
    static void validateThreadingParameters(std::int64_t& maxThreads,
                                            std::int64_t& numThreadsPerAllocation,
                                            std::int64_t& numAllocations);

private:
    std::int64_t m_MaxThreads;
    std::int64_t m_NumThreadsPerAllocation;
    std::int64_t m_NumAllocations;
};
}
}
