...
bool CCmdLineParser::parse(int argc,
    ...
    try {
        ...
        desc.add_options()("help", "Display this information and exit")("version", "Display version information and exit")(
            ...
            "modelconfig", boost::program_options::value<std::string>(), "Optional model config file")(
            "fieldconfig", boost::program_options::value<std::string>(), "Optional field config file")(
            "modelplotconfig", boost::program_options::value<std::string>(), "Optional model plot config file")(
            ...
            "bucketspan", boost::program_options::value<core_t::TTime>(), "Optional aggregation bucket span (in seconds) - default is 300")(
            "latency",
            ...
            "quantilesState", boost::program_options::value<std::string>(), "Optional file to quantiles for normalization")(
            "deleteStateFiles",
            ...
            "program exit")("maxQuantileInterval",
                            boost::program_options::value<core_t::TTime>(),
            ...
            "multivariateByFields", "Optional flag to enable multi-variate analysis of correlated by fields")(
            "multipleBucketspans",
            boost::program_options::value<std::string>(),
