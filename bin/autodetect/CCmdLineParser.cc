...
bool CCmdLineParser::parse(int argc,
    ...
    try {
        ...
        desc.add_options()("help", "Display this information and exit")(
            "version",
            "Display version information and exit")("limitconfig",
                                                    boost::program_options::value<std::string>(),
                                                    "Optional limit config file")(
            "modelconfig",
            boost::program_options::value<std::string>(),
            "Optional model config file")("fieldconfig",
                                          boost::program_options::value<std::string>(),
                                          "Optional field config file")(
            "modelplotconfig",
            boost::program_options::value<std::string>(),
            "Optional model plot config file")("jobid",
                                               boost::program_options::value<std::string>(),
            ...
            "timeformat",
            boost::program_options::value<std::string>(),
            "Optional format of the date in the time field in strptime code - default is the epoch "
            "time in seconds")("quantilesState",
                               boost::program_options::value<std::string>(),
                               "Optional file to quantiles for normalization")(
            "deleteStateFiles",
            "If the 'quantilesState' option is used and this flag is set then "
            "delete the model state files once they have been read")(
            "input",
            boost::program_options::value<std::string>(),
            ...
            "maxQuantileInterval",
            boost::program_options::value<core_t::TTime>(),
            "Optional interval at which to periodically output quantiles if they have not been "
            "output due to an anomaly - if not specified then quantiles will only be output "
            "following a big anomaly")("maxAnomalyRecords",
                                       boost::program_options::value<size_t>(),
                                       "The maximum number of records to be outputted for each "
                                       "bucket. Defaults to 100, a value 0 removes the limit.")(
            ...
            "The numer of half buckets to store before choosing which overlapping bucket has the "
            "biggest anomaly")(
            "multivariateByFields",
            "Optional flag to enable multi-variate analysis of correlated by fields")(
            "multipleBucketspans",
            boost::program_options::value<std::string>(),
            "Optional comma-separated list of additional bucketspans - must be direct multiples of "
            "the main bucketspan")("perPartitionNormalization",
