...
bool CCmdLineParser::parse(int argc,
    ...
    try {
        ...
        desc.add_options()("help", "Display this information and exit")("version", "Display version information and exit")(
            ...
            "outputIsPipe", "Specified output file is a named pipe")("quantilesState",
                                                                     boost::program_options::value<std::string>(),
                                                                     "Optional file to initialization data for normalization (in JSON)")(
            "deleteStateFiles", "If this flag is set then delete the normalizer state files once they have been read")(
