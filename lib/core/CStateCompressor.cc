...
size_t CStateCompressor::numCompressedDocs(void) const { return m_FilterSink.numCompressedDocs(); }
...
void CStateCompressor::CChunkFilter::close(void) { this->closeStream(true); }
...
bool CStateCompressor::CChunkFilter::allWritesSuccessful(void) { return m_WritesSuccessful; }

size_t CStateCompressor::CChunkFilter::numCompressedDocs(void) const { return m_CurrentDocNum - 1; }
