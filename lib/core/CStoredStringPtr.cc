...
void CStoredStringPtr::swap(CStoredStringPtr &other) noexcept { m_String.swap(other.m_String); }

const std::string &CStoredStringPtr::operator*() const noexcept { return *m_String; }

const std::string *CStoredStringPtr::operator->() const noexcept { return m_String.get(); }

const std::string *CStoredStringPtr::get() const noexcept { return m_String.get(); }

CStoredStringPtr::operator bool() const noexcept { return m_String.get() != nullptr; }

bool CStoredStringPtr::isUnique() const noexcept { return m_String.unique(); }

bool CStoredStringPtr::operator==(std::nullptr_t rhs) const noexcept { return m_String == rhs; }
...
std::size_t hash_value(const CStoredStringPtr &ptr) { return boost::hash_value(ptr.m_String); }

void swap(CStoredStringPtr &lhs, CStoredStringPtr &rhs) { lhs.swap(rhs); }
