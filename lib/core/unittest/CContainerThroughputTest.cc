...
void CContainerThroughputTest::testVector(void) {
    ...
    LOG_INFO("Vector throughput test with fill size " << FILL_SIZE << " and test size " << TEST_SIZE
...
void CContainerThroughputTest::testList(void) {
    ...
    LOG_INFO("List throughput test with fill size " << FILL_SIZE << " and test size " << TEST_SIZE
                                                    << " took " << (end - start) << " seconds");
}
...
void CContainerThroughputTest::testDeque(void) {
    ...
    LOG_INFO("Deque throughput test with fill size " << FILL_SIZE << " and test size " << TEST_SIZE
                                                     << " took " << (end - start) << " seconds");
}
...
void CContainerThroughputTest::testMap(void) {
    ...
    LOG_INFO("Map throughput test with fill size " << FILL_SIZE << " and test size " << TEST_SIZE
                                                   << " took " << (end - start) << " seconds");
}
...
void CContainerThroughputTest::testCircBuf(void) {
    ...
    LOG_INFO("Circular buffer throughput test with fill size "
             << FILL_SIZE << " and test size " << TEST_SIZE << " took " << (end - start)
             << " seconds");
}
...
void CContainerThroughputTest::testMultiIndex(void) {
    typedef boost::multi_index::multi_index_container<
        ...
        boost::multi_index::indexed_by<
            boost::multi_index::hashed_unique<BOOST_MULTI_INDEX_MEMBER(SContent, size_t, s_Size)>>>
        TContentMIndex;
