...
CppUnit::Test* CRegexFilterTest::suite() {
    ...
    suiteOfTests->addTest(new CppUnit::TestCaller<CRegexFilterTest>(
        "CRegexFilterTest::testConfigure_GivenInvalidRegex", &CRegexFilterTest::testConfigure_GivenInvalidRegex));
    ...
    suiteOfTests->addTest(new CppUnit::TestCaller<CRegexFilterTest>(
        "CRegexFilterTest::testApply_GivenSingleMatchAllRegex", &CRegexFilterTest::testApply_GivenSingleMatchAllRegex));
