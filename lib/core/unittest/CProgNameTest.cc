...
CppUnit::Test* CProgNameTest::suite() {
    ...
    suiteOfTests->addTest(
        new CppUnit::TestCaller<CProgNameTest>("CProgNameTest::testProgName", &CProgNameTest::testProgName));
    suiteOfTests->addTest(
        new CppUnit::TestCaller<CProgNameTest>("CProgNameTest::testProgDir", &CProgNameTest::testProgDir));
