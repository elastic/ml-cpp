...
CppUnit::Test* CPatternSetTest::suite() {
    ...
    suiteOfTests->addTest(new CppUnit::TestCaller<
                          CPatternSetTest>("CPatternSetTest::testInitFromJson_GivenInvalidJson",
    ...
    suiteOfTests->addTest(
        new CppUnit::TestCaller<
            CPatternSetTest>("CPatternSetTest::testInitFromJson_GivenArrayWithNonStringItem",
                             &CPatternSetTest::testInitFromJson_GivenArrayWithNonStringItem));
    suiteOfTests->addTest(
        new CppUnit::TestCaller<
            CPatternSetTest>("CPatternSetTest::testInitFromJson_GivenArrayWithDuplicates",
                             &CPatternSetTest::testInitFromJson_GivenArrayWithDuplicates));
    suiteOfTests->addTest(new CppUnit::TestCaller<
                          CPatternSetTest>("CPatternSetTest::testContains_GivenFullMatchKeys",
