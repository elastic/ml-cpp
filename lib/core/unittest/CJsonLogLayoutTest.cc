...
CppUnit::Test* CJsonLogLayoutTest::suite() {
    ...
    suiteOfTests->addTest(
        new CppUnit::TestCaller<CJsonLogLayoutTest>("CJsonLogLayoutTest::testPathCropping", &CJsonLogLayoutTest::testPathCropping));
...
#else
    CPPUNIT_ASSERT_EQUAL(std::string("source.h"), log4cxx::helpers::CJsonLogLayout::cropPath("/home/hendrik/src/include/source.h"));
    CPPUNIT_ASSERT_EQUAL(std::string("source.h"), log4cxx::helpers::CJsonLogLayout::cropPath("/home/hendrik/work/../src/include/source.h"));
#endif
}
