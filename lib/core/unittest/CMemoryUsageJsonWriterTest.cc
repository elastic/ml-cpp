...
void CMemoryUsageJsonWriterTest::test(void) {
    ...
    }
    {
        ...
        CPPUNIT_ASSERT_EQUAL(
            std::string("{\"Hello\":{\"memory\":223},\"Sheeple\":[{\"Womple\":{\"memory\":44}},{"
    ...
    }
    {
        ...
        writer.endObject();
        writer.finalise();
        CPPUNIT_ASSERT_EQUAL(std::string("{\"Hello\":{\"memory\":223},\"Sheeple\":[{\"Dumplings\":{"
                                         "\"memory\":345},\"Gravy\":{\"memory\":12341234}}]}\n"),
                             ss.str());
    }
}
