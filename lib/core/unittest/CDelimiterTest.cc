...
void CDelimiterTest::testQuoteEqualsEscapeTokenise(void) {
    ...
    std::string testData(
        ...
        "Pane?__a=1&data={\"\"pid\"\":34,\"\"data\"\":[\"\"a.163624624.35636.13135\"\",true,false]}"
        "&__user=6625141\",(9999),yetuth-atrat,info,client-to-server,0,0x0,192.168.0.0-192.168.255."
        "255,Some Country,0,application/x-javascript");
