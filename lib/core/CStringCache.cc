...
bool CStringCache::haveCopyOnWriteStrings(void) const { return m_HaveCopyOnWriteStrings; }
...
inline size_t CStringCache::CCharPHash::operator()(const char *) const { return m_Hash; }
