...
CPenalty *CPenalty::clone(void) const { return new CPenalty(*this); }
...
const CAutoconfigurerParams &CPenalty::params(void) const { return m_Params; }
...
CPenalty::CClosure::CClosure(const CPenalty &penalty) { this->add(penalty); }

CPenalty *CPenalty::CClosure::clone(void) const { return new CPenalty(*this); }
...
CPenalty::TPenaltyCPtrVec &CPenalty::CClosure::penalties(void) { return m_Penalties; }

CPenalty::CClosure operator*(const CPenalty &lhs, const CPenalty &rhs) {
    return CPenalty::CClosure(lhs).add(rhs);
}
CPenalty::CClosure operator*(CPenalty::CClosure lhs, const CPenalty &rhs) { return lhs.add(rhs); }

CPenalty::CClosure operator*(const CPenalty &lhs, CPenalty::CClosure rhs) { return rhs.add(lhs); }
}
}
