...
const std::string &CFieldStatistics::name(void) const { return m_FieldName; }
...
config_t::EDataType CFieldStatistics::type(void) const { return m_Semantics.type(); }
...
const CAutoconfigurerParams &CFieldStatistics::params(void) const { return m_Params; }
