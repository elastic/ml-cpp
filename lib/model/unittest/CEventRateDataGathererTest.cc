...
typedef CBucketGatherer::TSizeSizePrStoredStringPtrPrUInt64UMapVec
...
void CEventRateDataGathererTest::singleSeriesTests(void) {
    ...
    std::string expectedPersonNonZeroCounts[] = {std::string("[(0, 6)]"),
                                                 std::string("[(0, 3)]"),
                                                 std::string("[(0, 2)]"),
                                                 std::string("[]"),
                                                 std::string("[(0, 3)]")};

    std::string expectedPersonIndicator[] = {std::string("[(0, 1)]"),
                                             std::string("[(0, 1)]"),
                                             std::string("[(0, 1)]"),
                                             std::string("[]"),
                                             std::string("[(0, 1)]")};
...
void CEventRateDataGathererTest::testInfluencerBucketStatistics(void) {
    ...
    testInfluencerPerFeature(model_t::E_IndividualNonZeroCountByBucketAndPerson,
                             dataVec,
                             influencers,
                             expectedPersonNonZeroCountsVec,
                             "",
                             m_ResourceMonitor);
...
void CEventRateDataGathererTest::testDistinctStrings(void) {
...

    {
        ...
        data.insert("str3", influencers);
        {
            ...
            CPPUNIT_ASSERT_EQUAL(std::string("3, [[(inf1, ([2], 1)), (inf2, ([2], 1))], [(inf_v2, "
                                             "([1], 1)), (inf_v3, ([2], 1))]]"),
                                 featureData.print());
        }
    }
    ...
    }
    {
        ...
        data.insert("str3", influencers);
        {
            ...
            CPPUNIT_ASSERT_EQUAL(
                std::string("18, [[(inf1, ([16], 1)), (inf2, ([16], 1)), (inf3, ([12], 1))]]"),
                featureData.print());
        }
    }
    {
...
void CEventRateDataGathererTest::testDiurnalFeatures(void) {
    ...
    }
    {
        ...
        CPPUNIT_ASSERT(
            gatherer.hasFeature(model_t::E_PopulationTimeOfWeekByBucketPersonAndAttribute));
    ...
    }
    {
        ...
        CPPUNIT_ASSERT(
            gatherer.hasFeature(model_t::E_PopulationTimeOfDayByBucketPersonAndAttribute));
