...
CAnomalyDetectorModel *CMockModel::cloneForPersistence(void) const { return 0; }

model_t::EModelType CMockModel::category(void) const { return model_t::E_MetricOnline; }

bool CMockModel::isPopulation(void) const { return m_IsPopulation; }

bool CMockModel::isEventRate(void) const { return false; }

bool CMockModel::isMetric(void) const { return false; }
...
bool CMockModel::bucketStatsAvailable(core_t::TTime /*time*/) const { return false; }
...
uint64_t CMockModel::checksum(bool /*includeCurrentBucketStats*/) const { return 0; }

void CMockModel::debugMemoryUsage(core::CMemoryUsage::TMemoryUsagePtr /*mem*/) const {}

std::size_t CMockModel::memoryUsage(void) const { return 0; }

std::size_t CMockModel::computeMemoryUsage(void) const { return 0; }

std::size_t CMockModel::staticSize(void) const { return 0; }
...
double CMockModel::attributeFrequency(std::size_t /*cid*/) const { return 0.0; }

core_t::TTime CMockModel::currentBucketStartTime(void) const { return 0; }
...
const maths::CModel *CMockModel::model(std::size_t id) const { return m_Models[id].get(); }

void CMockModel::mockPopulation(bool isPopulation) { m_IsPopulation = isPopulation; }
...
void CMockModel::mockTimeSeriesModels(const TMathsModelPtrVec &models) { m_Models = models; }

CMemoryUsageEstimator *CMockModel::memoryUsageEstimator(void) const { return 0; }
...
const CAnomalyDetectorModel &CMockModelDetailsView::base() const { return *m_Model; }
