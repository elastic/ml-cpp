...
BOOST_AUTO_TEST_CASE(testErrors) {
    {
        ...
        BOOST_REQUIRE_EQUAL(config2.factory(1, INDIVIDUAL_COUNT)->modelParams().s_InitialDecayRateMultiplier,
                          config1.factory(1, INDIVIDUAL_COUNT)->modelParams().s_InitialDecayRateMultiplier);
        BOOST_REQUIRE_EQUAL(config2.factory(1, INDIVIDUAL_METRIC)->modelParams().s_InitialDecayRateMultiplier,
                          config1.factory(1, INDIVIDUAL_METRIC)->modelParams().s_InitialDecayRateMultiplier);
        BOOST_REQUIRE_EQUAL(config2.factory(1, POPULATION_COUNT)->modelParams().s_InitialDecayRateMultiplier,
                          config1.factory(1, POPULATION_COUNT)->modelParams().s_InitialDecayRateMultiplier);
        BOOST_REQUIRE_EQUAL(config2.factory(1, POPULATION_METRIC)->modelParams().s_InitialDecayRateMultiplier,
                          config1.factory(1, POPULATION_METRIC)->modelParams().s_InitialDecayRateMultiplier);
        BOOST_REQUIRE_EQUAL(config2.factory(1, INDIVIDUAL_COUNT)->modelParams().s_MaximumUpdatesPerBucket,
                          config1.factory(1, INDIVIDUAL_COUNT)->modelParams().s_MaximumUpdatesPerBucket);
        BOOST_REQUIRE_EQUAL(config2.factory(1, INDIVIDUAL_METRIC)->modelParams().s_MaximumUpdatesPerBucket,
                          config1.factory(1, INDIVIDUAL_METRIC)->modelParams().s_MaximumUpdatesPerBucket);
        BOOST_REQUIRE_EQUAL(config2.factory(1, POPULATION_COUNT)->modelParams().s_MaximumUpdatesPerBucket,
                          config1.factory(1, POPULATION_COUNT)->modelParams().s_MaximumUpdatesPerBucket);
        BOOST_REQUIRE_EQUAL(config2.factory(1, POPULATION_METRIC)->modelParams().s_MaximumUpdatesPerBucket,
        ...
        BOOST_REQUIRE_EQUAL(config2.factory(1, INDIVIDUAL_COUNT)->modelParams().s_SampleCountFactor,
                          config1.factory(1, INDIVIDUAL_COUNT)->modelParams().s_SampleCountFactor);
        BOOST_REQUIRE_EQUAL(config2.factory(1, INDIVIDUAL_METRIC)->modelParams().s_SampleCountFactor,
                          config1.factory(1, INDIVIDUAL_METRIC)->modelParams().s_SampleCountFactor);
        BOOST_REQUIRE_EQUAL(config2.factory(1, POPULATION_COUNT)->modelParams().s_SampleCountFactor,
                          config1.factory(1, POPULATION_COUNT)->modelParams().s_SampleCountFactor);
        BOOST_REQUIRE_EQUAL(config2.factory(1, POPULATION_METRIC)->modelParams().s_SampleCountFactor,
        ...
        BOOST_REQUIRE_EQUAL(config2.factory(1, INDIVIDUAL_COUNT)->modelParams().s_PruneWindowScaleMaximum,
                          config1.factory(1, INDIVIDUAL_COUNT)->modelParams().s_PruneWindowScaleMaximum);
        BOOST_REQUIRE_EQUAL(config2.factory(1, INDIVIDUAL_COUNT)->modelParams().s_PruneWindowScaleMinimum,
                          config1.factory(1, INDIVIDUAL_COUNT)->modelParams().s_PruneWindowScaleMinimum);
        BOOST_REQUIRE_EQUAL(config2.factory(1, INDIVIDUAL_METRIC)->modelParams().s_PruneWindowScaleMaximum,
                          config1.factory(1, INDIVIDUAL_METRIC)->modelParams().s_PruneWindowScaleMaximum);
        BOOST_REQUIRE_EQUAL(config2.factory(1, INDIVIDUAL_METRIC)->modelParams().s_PruneWindowScaleMinimum,
                          config1.factory(1, INDIVIDUAL_METRIC)->modelParams().s_PruneWindowScaleMinimum);
        BOOST_REQUIRE_EQUAL(config2.factory(1, POPULATION_COUNT)->modelParams().s_PruneWindowScaleMaximum,
                          config1.factory(1, POPULATION_COUNT)->modelParams().s_PruneWindowScaleMaximum);
        BOOST_REQUIRE_EQUAL(config2.factory(1, POPULATION_COUNT)->modelParams().s_PruneWindowScaleMinimum,
                          config1.factory(1, POPULATION_COUNT)->modelParams().s_PruneWindowScaleMinimum);
        BOOST_REQUIRE_EQUAL(config2.factory(1, POPULATION_METRIC)->modelParams().s_PruneWindowScaleMaximum,
                          config1.factory(1, POPULATION_METRIC)->modelParams().s_PruneWindowScaleMaximum);
        BOOST_REQUIRE_EQUAL(config2.factory(1, POPULATION_METRIC)->modelParams().s_PruneWindowScaleMinimum,
