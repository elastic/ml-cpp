...
void CAnomalyScoreTest::testNormalizeScoresQuantiles(void) {
    ...
    for (std::size_t i = 0u; i < samples.size(); ++i) {
        ...
        double trueQuantile =
            static_cast<double>(std::distance(scores.begin(), itr)) / static_cast<double>(scores.size());
...
void CAnomalyScoreTest::testJsonConversion(void) {
    ...
    model::CAnomalyScore::CNormalizer restoredNormalizer(config);
    {
        ...
        traverser.traverseSubLevel(
            boost::bind(&model::CAnomalyScore::CNormalizer::acceptRestoreTraverser, &restoredNormalizer, _1));
    }
...
CppUnit::Test* CAnomalyScoreTest::suite(void) {
    ...
    suiteOfTests->addTest(new CppUnit::TestCaller<CAnomalyScoreTest>("CAnomalyScoreTest::testComputeScores",
    ...
    suiteOfTests->addTest(new CppUnit::TestCaller<CAnomalyScoreTest>(
        "CAnomalyScoreTest::testNormalizeScoresLargeScore", &CAnomalyScoreTest::testNormalizeScoresLargeScore));
    ...
    suiteOfTests->addTest(new CppUnit::TestCaller<CAnomalyScoreTest>("CAnomalyScoreTest::testJsonConversion",
                                                                     &CAnomalyScoreTest::testJsonConversion));
    suiteOfTests->addTest(new CppUnit::TestCaller<CAnomalyScoreTest>("CAnomalyScoreTest::testPersistEmpty",
