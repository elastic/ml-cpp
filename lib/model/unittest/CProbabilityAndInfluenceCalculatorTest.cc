...
using TStoredStringPtrStoredStringPtrPrDoublePrVec = model::CProbabilityAndInfluenceCalculator::TStoredStringPtrStoredStringPtrPrDoublePrVec;
                                     ...
                                     TStoredStringPtrStoredStringPtrPrDoublePrVec &influences)
{
    ...
    for (std::size_t i = 0u; i < values.size(); ++i)
    {
        ...
        TSize1Vec mostAnomalousCorrelate;
        calculator.addProbability(feature, 0, model, 0/*elapsedTime*/,
                                  params_, time, value,
...
void CProbabilityAndInfluenceCalculatorTest::testLogProbabilityComplementInfluenceCalculator()
{
...

    {
        LOG_DEBUG("Test univariate");
        {
            ...
            TStoredStringPtrStoredStringPtrPrDoublePrVec influences;
            computeInfluences(calculator,
                              model_t::E_IndividualCountByBucketAndPerson, model,
                              0/*time*/, 20.0/*value*/, 1.0/*count*/,
...
void CProbabilityAndInfluenceCalculatorTest::testMeanInfluenceCalculator()
{
...

    {
        LOG_DEBUG("Test univariate");
        {
            ...
            TStoredStringPtrStoredStringPtrPrDoublePrVec influences;
            computeInfluences(calculator,
                              model_t::E_IndividualMeanByPerson, model,
                              0/*time*/, 5.0/*value*/, 1.0/*count*/,
                              p, tail, I, influencerValues, influences);
        ...
        }
        {
...

            {
                ...
                TStrCRefDouble1VecDoublePrPrVec influencerValues{{TStrCRef(i1), make_pair(20.0, 5.0)},
            ...
            }
            {
                ...
                TStrCRefDouble1VecDoublePrPrVec influencerValues{{TStrCRef(i1), make_pair(5.0, 5.0)},
                                                                 {TStrCRef(i2), make_pair(5.0, 6.0)}};

                TStoredStringPtrStoredStringPtrPrDoublePrVec influences;
                computeInfluences(calculator,
                                  model_t::E_IndividualMeanByPerson, model,
                                  0/*time*/, 5.0/*value*/, 11.0/*count*/,
                                  p, tail, I, influencerValues, influences);
            ...
            }
            {
                ...
                TStrCRefDouble1VecDoublePrPrVec influencerValues{{TStrCRef(i1), make_pair(5.0,  9.0)},
...
void CProbabilityAndInfluenceCalculatorTest::testLogProbabilityInfluenceCalculator()
{
...

    {
        LOG_DEBUG("Test univariate");
        {
            ...
            TStoredStringPtrStoredStringPtrPrDoublePrVec influences;
            computeInfluences(calculator,
                              model_t::E_IndividualUniqueCountByBucketAndPerson, model,
                              now/*time*/, 5.0/*value*/, 1.0/*count*/,
                              p, tail, I, influencerValues, influences);
        ...
        }
        {
            ...
            for (std::size_t i = 0u; i < testTimes.size(); ++i)
            {
                ...
                TStoredStringPtrStoredStringPtrPrDoublePrVec influences;
                computeInfluences(calculator,
                                  model_t::E_IndividualHighUniqueCountByBucketAndPerson, model,
                                  time, 60.0/*value*/, 1.0/*count*/,
                                  p, tail, I, influencerValues, influences);
...
void CProbabilityAndInfluenceCalculatorTest::testIndicatorInfluenceCalculator()
{
...

    {
        ...
        TStoredStringPtrStoredStringPtrPrDoublePrVec influences;
        computeInfluences(calculator,
                          model_t::E_IndividualIndicatorOfBucketPerson, model,
                          0/*time*/, 1.0/*value*/, 1.0/*count*/,
...
void CProbabilityAndInfluenceCalculatorTest::testProbabilityAndInfluenceCalculator()
{
...

    {
        ...
        for (std::size_t i = 0u; i < 5; ++i)
        {
            for (std::size_t j = 0u; j < features.size(); ++j)
            {
                ...
                model_t::CResultType type;
                TSize1Vec mostAnomalousCorrelate;
                calculator.addProbability(features[j], 0, *models[j],
                                          0/*elapsedTime*/, params_,
                                          TTime2Vec1Vec{TTime2Vec{now}}, value,
                                          p, tail, type, mostAnomalousCorrelate);
                pJoint.add(p);
                pExtreme.add(p);
                model::CProbabilityAndInfluenceCalculator::SParams params(partitioningFields);
    ...
    }
    {
        ...
        TDoubleVecVec values[]{TDoubleVecVec{{12.0, 1.0},
                                             {15.0, 1.0},
                                             { 7.0,  1.5},
                                             { 9.0,  1.0},
                                             {17.0, 2.0}},
    ...
    }
    {
        ...
        TDoubleVecVec values[]{TDoubleVecVec{{11.0, 1.0},
                                             {10.5, 1.0},
                                             {8.5,  1.5},
                                             {10.8, 1.5},
                                             {19.0, 1.0}},
