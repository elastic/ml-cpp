    ...
    if (result.second) {
        ...
        for (auto feature : features) {
            ...
            result.first->second.emplace_back(
                feature, this->defaultFeatureModel(feature, bucketLength,
...
CModelFactory::defaultDecomposition(model_t::EFeature feature,
    ...
    return boost::make_shared<maths::CTimeSeriesDecomposition>(decayRate, bucketLength,
