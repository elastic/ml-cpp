...
CDataGatherer *CEventRatePopulationModelFactory::makeDataGatherer(
    const SGathererInitializationData &initData) const {
...
bool CEventRatePopulationModelFactory::isSimpleCount(void) const { return false; }
