...
model_t::ESummaryMode CEventRateModelFactory::summaryMode(void) const { return m_SummaryMode; }

maths_t::EDataType CEventRateModelFactory::dataType(void) const { return maths_t::E_IntegerData; }
