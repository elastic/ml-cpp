...
CModelParams stubParameters(void) { return CModelParams(0, LEARN_RATE, DECAY_RATE, 0.0); }
}
...
core_t::TTime CModelParams::bucketLength(void) const { return m_BucketLength; }

double CModelParams::learnRate(void) const { return m_LearnRate; }

double CModelParams::decayRate(void) const { return m_DecayRate; }

double CModelParams::averagingDecayRate(void) const { return 5.0 * m_DecayRate; }
...
double CModelParams::probabilityBucketEmpty(void) const { return m_ProbabilityBucketEmpty; }
...
maths_t::EDataType CModelAddSamplesParams::type(void) const { return m_Type; }
...
bool CModelAddSamplesParams::isNonNegative(void) const { return m_IsNonNegative; }
...
double CModelAddSamplesParams::propagationInterval(void) const { return m_PropagationInterval; }
...
std::size_t CModelProbabilityParams::tag(void) const { return m_Tag; }
...
std::size_t CModelProbabilityParams::calculations(void) const { return m_Calculations.size(); }
...
bool CModelProbabilityParams::updateAnomalyModel(void) const { return m_UpdateAnomalyModel; }
...
const CModelParams &CModel::params(void) const { return m_Params; }

CModelParams &CModel::params(void) { return m_Params; }
...
std::size_t CModelStub::identifier(void) const { return 0; }

CModelStub *CModelStub::clone(std::size_t /*id*/) const { return new CModelStub(*this); }

CModelStub *CModelStub::cloneForPersistence(void) const { return new CModelStub(*this); }

CModelStub *CModelStub::cloneForForecast(void) const { return new CModelStub(*this); }

bool CModelStub::isForecastPossible(void) const { return false; }

void CModelStub::modelCorrelations(CTimeSeriesCorrelations & /*model*/) {}

CModelStub::TSize2Vec1Vec CModelStub::correlates(void) const { return TSize2Vec1Vec(); }
...
std::uint64_t CModelStub::checksum(std::uint64_t seed) const { return seed; }

void CModelStub::debugMemoryUsage(core::CMemoryUsage::TMemoryUsagePtr /*mem*/) const {}

std::size_t CModelStub::memoryUsage(void) const { return 0; }

void CModelStub::acceptPersistInserter(core::CStatePersistInserter & /*inserter*/) const {}

maths_t::EDataType CModelStub::dataType(void) const { return maths_t::E_MixedData; }
}
}
