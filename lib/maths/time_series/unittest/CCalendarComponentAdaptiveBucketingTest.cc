...
BOOST_FIXTURE_TEST_CASE(testRefine, CTestFixture) {
    ...
    LOG_DEBUG(<< "mean error         = " << maths::common::CBasicStatistics::mean(meanError1));
    LOG_DEBUG(<< "max error          = " << maxError1[0]);
    LOG_DEBUG(<< "refined mean error = " << maths::common::CBasicStatistics::mean(meanError2));
    LOG_DEBUG(<< "refined max error  = " << maxError2[0]);
    BOOST_TEST_REQUIRE(maths::common::CBasicStatistics::mean(meanError2) <
                       0.7 * maths::common::CBasicStatistics::mean(meanError1));
...
BOOST_FIXTURE_TEST_CASE(testKnots, CTestFixture) {
    ...
    LOG_DEBUG(<< "*** Variances ***");
    {
        ...
        LOG_DEBUG(<< "meanError    = " << maths::common::CBasicStatistics::mean(meanError));
        LOG_DEBUG(<< "meanVariance = " << maths::common::CBasicStatistics::mean(meanVariance));
        BOOST_TEST_REQUIRE(maths::common::CBasicStatistics::mean(meanError) /
