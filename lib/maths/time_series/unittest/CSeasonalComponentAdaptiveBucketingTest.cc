...
BOOST_AUTO_TEST_CASE(testInitialize) {
    maths::time_series::CGeneralPeriodTime time(100);
    maths::time_series::CSeasonalComponentAdaptiveBucketing bucketing(time);
    ...
    bucketing.knots(1, maths::common::CSplineTypes::E_Periodic, knots, values, variances);
...
BOOST_AUTO_TEST_CASE(testSwap) {
    maths::time_series::CGeneralPeriodTime time1(100);
    maths::time_series::CSeasonalComponentAdaptiveBucketing bucketing1(time1, 0.05);
...
BOOST_AUTO_TEST_CASE(testRefine) {
...

    {
        ...
        maths::time_series::CDiurnalTime time(0, 0, core::constants::WEEK,
                                              core::constants::DAY);
        maths::time_series::CSeasonalComponentAdaptiveBucketing bucketing1(time);
        maths::time_series::CSeasonalComponentAdaptiveBucketing bucketing2(time);
        ...
        LOG_DEBUG(<< "mean error         = "
                  << maths::common::CBasicStatistics::mean(meanError1));
        LOG_DEBUG(<< "max error          = " << maxError1[0]);
        LOG_DEBUG(<< "refined mean error = "
                  << maths::common::CBasicStatistics::mean(meanError2));
        LOG_DEBUG(<< "refined max error  = " << maxError2[0]);
        BOOST_TEST_REQUIRE(maths::common::CBasicStatistics::mean(meanError2) <
                           0.85 * maths::common::CBasicStatistics::mean(meanError1));
...

    {
        ...
        maths::time_series::CGeneralPeriodTime time(100);
        maths::time_series::CSeasonalComponentAdaptiveBucketing bucketing(time, 0.05);
        ...
        double meanError_ = maths::common::CBasicStatistics::mean(meanError);
        double varianceError_ = maths::common::CBasicStatistics::mean(varianceError);
        ...
        double avgErrorMean = maths::common::CBasicStatistics::mean(avgError);
        double avgErrorStd = std::sqrt(maths::common::CBasicStatistics::variance(avgError));
...
BOOST_AUTO_TEST_CASE(testPropagateForwardsByTime) {
    ...
    maths::time_series::CGeneralPeriodTime time(100);
    maths::time_series::CSeasonalComponentAdaptiveBucketing bucketing(time, 0.2);
...
BOOST_AUTO_TEST_CASE(testMinimumBucketLength) {
    ...
    maths::time_series::CSeasonalComponentAdaptiveBucketing bucketing1(time, 0.0, 0.0);
    maths::time_series::CSeasonalComponentAdaptiveBucketing bucketing2(time, 0.0, 3000.0);
...
BOOST_AUTO_TEST_CASE(testUnintialized) {
    ...
    maths::time_series::CGeneralPeriodTime time(10);
    maths::time_series::CSeasonalComponentAdaptiveBucketing bucketing(time, 0.1);
    ...
    TDoubleVec values;
    TDoubleVec variances;
    bucketing.knots(10, maths::common::CSplineTypes::E_Periodic, knots, values, variances);
...
BOOST_AUTO_TEST_CASE(testKnots) {
    ...
    LOG_DEBUG(<< "*** Values ***");
    {
        maths::time_series::CDiurnalTime time(0, 0, core::constants::WEEK,
                                              core::constants::DAY);
        maths::time_series::CSeasonalComponentAdaptiveBucketing bucketing(time, 0.1, 864.0);
        ...
        for (std::size_t p = 0; p < 5; ++p) {
            ...
            LOG_DEBUG(<< "meanValue = " << maths::common::CBasicStatistics::mean(meanValue));
            BOOST_TEST_REQUIRE(maths::common::CBasicStatistics::mean(meanError) /
                                   maths::common::CBasicStatistics::mean(meanValue) <
    ...
    LOG_DEBUG(<< "*** Variances ***");
    {
        ...
        for (std::size_t p = 0; p < 50; ++p) {
            ...
            if ((p + 1) % 10 == 0) {
                ...
                LOG_DEBUG(<< "meanVariance = "
                          << maths::common::CBasicStatistics::mean(meanVariance));
                BOOST_TEST_REQUIRE(maths::common::CBasicStatistics::mean(meanError) /
                                       maths::common::CBasicStatistics::mean(meanVariance) <
                                   0.2);
            }
...
BOOST_AUTO_TEST_CASE(testLongTermTrendKnots) {
    ...
    maths::time_series::CDiurnalTime time(0, 0, core::constants::WEEK, core::constants::DAY);
    maths::time_series::CSeasonalComponentAdaptiveBucketing bucketing(time, 0.1, 864.0);
    maths::time_series::CSeasonalComponentAdaptiveBucketing::TFloatMeanAccumulatorVec empty;
...
BOOST_AUTO_TEST_CASE(testShiftValue) {
    ...
    maths::time_series::CDiurnalTime time(0, 0, core::constants::WEEK, core::constants::DAY);
    maths::time_series::CSeasonalComponentAdaptiveBucketing bucketing(time, 0.1, 600.0);
    maths::time_series::CSeasonalComponentAdaptiveBucketing::TFloatMeanAccumulatorVec empty;
    ...
    bucketing.knots(t + 7 * 86400, maths::common::CSplineTypes::E_Natural,
                    knots1, values1, variances1);
...
BOOST_AUTO_TEST_CASE(testPersist) {
    ...
    maths::time_series::CDiurnalTime time(0, 0, core::constants::WEEK, core::constants::DAY);
    maths::time_series::CSeasonalComponentAdaptiveBucketing origBucketing(
        time, decayRate, minimumBucketLength);
...
BOOST_AUTO_TEST_CASE(testUpgrade) {
    ...
    maths::time_series::CDiurnalTime time(0, 0, core::constants::WEEK, core::constants::DAY);
    maths::time_series::CSeasonalComponentAdaptiveBucketing expectedBucketing(
        time, decayRate, minimumBucketLength);
    ...
    expectedBucketing.knots(863136, maths::common::CSplineTypes::E_Periodic,
...
BOOST_AUTO_TEST_CASE(testName) {
    ...
    maths::time_series::CDiurnalTime time(0, 0, core::constants::WEEK, core::constants::DAY);
    maths::time_series::CSeasonalComponentAdaptiveBucketing bucketing(
        time, decayRate, minimumBucketLength);
