...
void CTrendComponent::acceptPersistInserter(core::CStatePersistInserter& inserter) const {
    ...
    inserter.insertLevel(PROBABILITY_OF_LEVEL_CHANGE_MODEL_TAG,
                         std::bind(&common::CNaiveBayes::acceptPersistInserter,
                                   &m_ProbabilityOfLevelChangeModel, std::placeholders::_1));
    inserter.insertLevel(
        MAGNITUDE_OF_LEVEL_CHANGE_MODEL_TAG,
        std::bind(&common::CNormalMeanPrecConjugate::acceptPersistInserter,
...
bool CTrendComponent::acceptRestoreTraverser(const common::SDistributionRestoreParams& params,
    ...
    do {
        ...
        RESTORE_NO_ERROR(PROBABILITY_OF_LEVEL_CHANGE_MODEL_TAG,
                         m_ProbabilityOfLevelChangeModel = std::move(common::CNaiveBayes(
