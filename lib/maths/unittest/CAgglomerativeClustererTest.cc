...
void CAgglomerativeClustererTest::testNode() {
...

    {
        ...
        CPPUNIT_ASSERT_EQUAL(std::string("[(1, [0, 1]), (1.5, [2, 3]), (1.9, "
                                         "[4, 2, 3]), (4, [0, 1, 4, 2, 3])]"),
...
void CAgglomerativeClustererTest::testDegenerate() {
    ...
    std::string expected[][3] = {
        {std::string("[(3.3, [0, 1, 2, 3, 4, 5]), (2.2, [0, 1, 2, 3, 4]), "
                     "(1.3, [1, 2, 3, 4]), (0, [1, 2, 3]), (0, [1, 2])]"),
         std::string("[(3.3, [0, 1, 2, 3, 4, 5]), (2.2, [0, 1, 2, 3, 4]), "
                     "(1.3, [1, 2, 3, 4]), (0, [1, 2, 3]), (0, [1, 3])]"),
         std::string("[(3.3, [0, 1, 2, 3, 4, 5]), (2.2, [0, 1, 2, 3, 4]), "
                     "(1.3, [1, 2, 3, 4]), (0, [1, 2, 3]), (0, [2, 3])]")},
        {std::string("[(6.8, [0, 1, 2, 3, 4, 5]), (3.5, [0, 1, 2, 3, 4]), "
                     "(1.3, [1, 2, 3, 4]), (0, [1, 2, 3]), (0, [1, 2])]"),
         std::string("[(6.8, [0, 1, 2, 3, 4, 5]), (3.5, [0, 1, 2, 3, 4]), "
                     "(1.3, [1, 2, 3, 4]), (0, [1, 2, 3]), (0, [1, 3])]"),
         std::string("[(6.8, [0, 1, 2, 3, 4, 5]), (3.5, [0, 1, 2, 3, 4]), "
