...
COneOfNPrior makeModePrior(const double& decayRate = 0.0) {
    CGammaRateConjugate gamma(maths::common::CGammaRateConjugate::nonInformativePrior(
        maths_t::E_ContinuousData, 0.01, decayRate, 0.0));
    CLogNormalMeanPrecConjugate logNormal(maths::common::CLogNormalMeanPrecConjugate::nonInformativePrior(
        maths_t::E_ContinuousData, 0.01, decayRate, 0.0));
    CNormalMeanPrecConjugate normal(maths::common::CNormalMeanPrecConjugate::nonInformativePrior(
    ...
    return COneOfNPrior(
        maths::common::COneOfNPrior(priors, maths_t::E_ContinuousData, decayRate));
}

//! Make a vanilla multimodal prior.
CMultimodalPrior makePrior(const maths::common::CPrior* modePrior, const double& decayRate) {
    ...
    if (modePrior) {
        return maths::common::CMultimodalPrior(maths_t::E_ContinuousData,
                                               clusterer, *modePrior, decayRate);
    }
    return maths::common::CMultimodalPrior(maths_t::E_ContinuousData, clusterer,
                                           makeModePrior(decayRate), decayRate);
}
CMultimodalPrior makePrior(const maths::common::CPrior* modePrior) {
...
template<typename T>
void probabilityOfLessLikelySample(const maths::common::CMixtureDistribution<T>& mixture,
                                   const double& x,
                                   double& probability,
                                   double& deviation) {
    using TModeVec = typename maths::common::CMixtureDistribution<T>::TModeVec;
...
BOOST_AUTO_TEST_CASE(testMultipleUpdate) {
    ...
    for (size_t i = 0; i < std::size(dataTypes); ++i) {
        ...
        CMultimodalPrior filter1(maths::common::CMultimodalPrior(
            dataTypes[i], clusterer,
            maths::common::CNormalMeanPrecConjugate::nonInformativePrior(dataTypes[i], decayRate)));
...
BOOST_AUTO_TEST_CASE(testSingleMode) {
    ...
    LOG_DEBUG(<< "Gaussian");
    {
        ...
        LOG_DEBUG(<< "L1G = " << maths::common::CBasicStatistics::mean(L1G)
                  << ", L12 = " << maths::common::CBasicStatistics::mean(L12)
                  << ", differential entropy " << differentialEntropy);

        BOOST_TEST_REQUIRE(maths::common::CBasicStatistics::mean(L1G) /
                               maths::common::CBasicStatistics::mean(differentialEntropy) <
                           0.0);
    }
...
BOOST_AUTO_TEST_CASE(testMarginalLikelihood) {
...

    {
        ...
        maths::common::CMixtureDistribution<boost::math::normal_distribution<>> f(weights, modes);
        double expectedDifferentialEntropy = maths::common::CTools::differentialEntropy(f);
...
BOOST_AUTO_TEST_CASE(testMarginalLikelihoodConfidenceInterval) {
    ...
    LOG_DEBUG(<< "Synthetic");
    {
        ...
        for (std::size_t i = 0; i < std::size(varianceScales); ++i) {
            ...
            BOOST_TEST_REQUIRE(maths::common::CBasicStatistics::mean(error) < 5e-3);
        }
        ...
        LOG_DEBUG(<< "error = " << maths::common::CBasicStatistics::mean(error));
        BOOST_TEST_REQUIRE(maths::common::CBasicStatistics::mean(error) < 0.05);
    }

    LOG_DEBUG(<< "Problem Case (Issue 439)");
    {
        std::ifstream file{"testfiles/poorly_conditioned_multimodal.txt"};
        BOOST_TEST_REQUIRE(file.is_open());
        std::ostringstream state;
        state << file.rdbuf();

        std::istringstream stateStrm(state.str());
        core::CJsonStateRestoreTraverser traverser(stateStrm);
        maths::common::SDistributionRestoreParams params(
            maths_t::E_ContinuousData, 0.0, maths::common::MINIMUM_CLUSTER_SPLIT_FRACTION,
            maths::common::MINIMUM_CLUSTER_SPLIT_COUNT,
            maths::common::MINIMUM_CATEGORY_COUNT);
        TPriorPtr prior;
        maths::common::CPriorStateSerialiser restorer;
...
BOOST_AUTO_TEST_CASE(testSampleMarginalLikelihood) {
    ...
    for (std::size_t i = 0; i < 3; ++i) {
        ...
        LOG_DEBUG(<< "sampleMean = " << maths::common::CBasicStatistics::mean(sampleMoments)
                  << ", sampledMean = "
                  << maths::common::CBasicStatistics::mean(sampledMoments));
        LOG_DEBUG(<< "sampleVariance = "
                  << maths::common::CBasicStatistics::variance(sampleMoments) << ", sampledVariance = "
                  << maths::common::CBasicStatistics::variance(sampledMoments));

        BOOST_REQUIRE_CLOSE_ABSOLUTE(
            maths::common::CBasicStatistics::mean(sampleMoments),
            maths::common::CBasicStatistics::mean(sampledMoments),
            0.05 * maths::common::CBasicStatistics::mean(sampleMoments));

        BOOST_REQUIRE_CLOSE_ABSOLUTE(
            maths::common::CBasicStatistics::variance(sampleMoments),
            maths::common::CBasicStatistics::variance(sampledMoments),
            std::max(1e-6, 0.55 * maths::common::CBasicStatistics::variance(sampleMoments)));
    }
    ...
    BOOST_TEST_REQUIRE(maths::common::CBasicStatistics::mean(meanMeanError) < 0.0015);
    LOG_DEBUG(<< "mean variance error = "
              << maths::common::CBasicStatistics::mean(meanVarError));
    BOOST_TEST_REQUIRE(maths::common::CBasicStatistics::mean(meanVarError) < 0.04);
    ...
    BOOST_REQUIRE_CLOSE_ABSOLUTE(
        maths::common::CBasicStatistics::mean(sampleMoments),
        maths::common::CBasicStatistics::mean(sampledMoments),
        1e-4 * maths::common::CBasicStatistics::mean(sampleMoments));
    BOOST_REQUIRE_CLOSE_ABSOLUTE(
        maths::common::CBasicStatistics::variance(sampleMoments),
        maths::common::CBasicStatistics::variance(sampledMoments),
        0.05 * maths::common::CBasicStatistics::variance(sampleMoments));
    BOOST_REQUIRE_CLOSE_ABSOLUTE(
        maths::common::CBasicStatistics::skewness(sampleMoments),
        maths::common::CBasicStatistics::skewness(sampledMoments),
        0.1 * maths::common::CBasicStatistics::skewness(sampleMoments));
}
...
BOOST_AUTO_TEST_CASE(testCdf) {
    ...
    CLogNormalMeanPrecConjugate logNormal(
        maths::common::CLogNormalMeanPrecConjugate::nonInformativePrior(maths_t::E_ContinuousData));
    COneOfNPrior::TPriorPtrVec priors;
    priors.push_back(COneOfNPrior::TPriorPtr(gamma.clone()));
    priors.push_back(COneOfNPrior::TPriorPtr(logNormal.clone()));
...
BOOST_AUTO_TEST_CASE(testProbabilityOfLessLikelySamples) {
...

    {
        ...
        modes.push_back(boost::math::normal_distribution<>(mean1, variance1));
        modes.push_back(boost::math::normal_distribution<>(mean2, variance2));
        maths::common::CMixtureDistribution<boost::math::normal_distribution<>> mixture(
            weights, modes);
    ...
    }
    {
        ...
        maths::common::CMixtureDistribution<boost::math::lognormal_distribution<>> mixture(
    ...
    }
    {
        ...
        maths::common::CMixtureDistribution<boost::math::gamma_distribution<>> mixture(
            mixtureWeights, modes);
...
BOOST_AUTO_TEST_CASE(testLargeValues) {
    ...
    maths::common::CGammaRateConjugate gammaPrior =
        maths::common::CGammaRateConjugate::nonInformativePrior(
    ...
    maths::common::CNormalMeanPrecConjugate normalPrior =
        maths::common::CNormalMeanPrecConjugate::nonInformativePrior(
            maths_t::E_ContinuousData, 0.001);
    ...
    maths::common::COneOfNPrior modePrior(modePriors, maths_t::E_ContinuousData, 0.001);
    maths::common::CXMeansOnline1d clusterer(
        maths_t::E_ContinuousData, maths::common::CAvailableModeDistributions::ALL,
        maths_t::E_ClustersFractionWeight, 0.001, 0.05, 12, 0.8 / 3.0);
    maths::common::CMultimodalPrior multimodalPrior(maths_t::E_ContinuousData,
...
BOOST_AUTO_TEST_CASE(testPersist) {
    ...
    maths::common::CXMeansOnline1d clusterer(
        maths_t::E_ContinuousData, maths::common::CAvailableModeDistributions::ALL,
        maths_t::E_ClustersFractionWeight);
    maths::common::CGammaRateConjugate gamma = maths::common::CGammaRateConjugate::nonInformativePrior(
        maths_t::E_ContinuousData, 0.01);
    maths::common::CLogNormalMeanPrecConjugate logNormal =
        maths::common::CLogNormalMeanPrecConjugate::nonInformativePrior(
            maths_t::E_ContinuousData, 0.01);
    ...
    maths::common::CMultimodalPrior origFilter(maths_t::E_ContinuousData, clusterer, modePrior);
    for (std::size_t i = 0; i < samples.size(); ++i) {
    ...
    core::CJsonStatePersistInserter::persist(
        origJson, std::bind_front(&maths::common::CMultimodalPrior::acceptPersistInserter,
                                  &origFilter));
    ...
    maths::common::CMultimodalPrior restoredFilter(params, traverser);
    ...
    core::CJsonStatePersistInserter::persist(
        newJson, std::bind_front(&maths::common::CMultimodalPrior::acceptPersistInserter,
                                 &restoredFilter));
