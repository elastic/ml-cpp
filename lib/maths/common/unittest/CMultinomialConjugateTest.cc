...
using CMultinomialConjugate = CPriorTestInterfaceMixin<maths::common::CMultinomialConjugate>;
...
BOOST_AUTO_TEST_CASE(testMarginalLikelihood) {
...

    {
        ...
        CMultinomialConjugate filter(
            maths::common::CMultinomialConjugate(3, categories, concentrations));
...
BOOST_AUTO_TEST_CASE(testRemoveCategories) {
    ...
    {
        CMultinomialConjugate prior(maths::common::CMultinomialConjugate(
            100, categories, concentrationParameters));
    ...
    {
        CMultinomialConjugate prior(maths::common::CMultinomialConjugate(
            90, categories, concentrationParameters));
    ...
    {
        CMultinomialConjugate prior(maths::common::CMultinomialConjugate(
            10, categories, concentrationParameters));
...
BOOST_AUTO_TEST_CASE(testPersist) {
    ...
    TDoubleVec samples;
    rng.generateMultinomialSamples(categories, probabilities, 100, samples);
    maths::common::CMultinomialConjugate origFilter(
        CMultinomialConjugate::nonInformativePrior(5));
    for (std::size_t i = 0; i < samples.size(); ++i) {
    ...
    maths::common::CMultinomialConjugate restoredFilter(params, traverser);
