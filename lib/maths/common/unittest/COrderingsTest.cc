...
BOOST_AUTO_TEST_CASE(testLess) {
    maths::common::COrderings::SLess less;
...
BOOST_AUTO_TEST_CASE(testFirstLess) {
    maths::common::COrderings::SFirstLess less;
...
BOOST_AUTO_TEST_CASE(testFirstGreater) {
    maths::common::COrderings::SFirstGreater greater;
...
BOOST_AUTO_TEST_CASE(testSecondLess) {
    maths::common::COrderings::SSecondLess less;
...
BOOST_AUTO_TEST_CASE(testSecondGreater) {
    maths::common::COrderings::SSecondGreater greater;
...
BOOST_AUTO_TEST_CASE(testLexicographicalCompare) {
    ...
    maths::common::COrderings::SReferenceGreater greater;
    ...
    BOOST_TEST_REQUIRE(!maths::common::COrderings::lexicographical_compare(i1, i2, greater));
    BOOST_TEST_REQUIRE(!maths::common::COrderings::lexicographical_compare(i1, i1, greater));
    BOOST_TEST_REQUIRE(maths::common::COrderings::lexicographical_compare(i2, i1, greater));
    ...
    BOOST_TEST_REQUIRE(!maths::common::COrderings::lexicographical_compare(
        i1, p1, i1, p1, greater));
    BOOST_TEST_REQUIRE(
        maths::common::COrderings::lexicographical_compare(i2, p1, i1, p1, greater));
    BOOST_TEST_REQUIRE(
        maths::common::COrderings::lexicographical_compare(i1, p2, i1, p1, greater));
    ...
    BOOST_TEST_REQUIRE(maths::common::COrderings::lexicographical_compare(
        i2, p1, d1, i1, p1, d1, greater));
    BOOST_TEST_REQUIRE(maths::common::COrderings::lexicographical_compare(
        i1, p2, d1, i1, p1, d1, greater));
    BOOST_TEST_REQUIRE(maths::common::COrderings::lexicographical_compare(
        i1, p1, d2, i1, p1, d1, greater));
