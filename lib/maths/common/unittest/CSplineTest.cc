...
public:
    CSplineFunctor(const maths::common::CSpline<>& spline)
        : m_Spline(&spline) {}
...
private:
    const maths::common::CSpline<>* m_Spline;
};

std::string print(maths::common::CSplineTypes::EType type) {
    switch (type) {
    case maths::common::CSplineTypes::E_Linear:
        return "linear";
    case maths::common::CSplineTypes::E_Cubic:
        return "cubic";
    }
    return std::string();
}
...
BOOST_AUTO_TEST_CASE(testNatural) {
...

    {
        ...
        spline.interpolate(x, y, maths::common::CSplineTypes::E_Natural);
...
BOOST_AUTO_TEST_CASE(testParabolicRunout) {
    {
        ...
        maths::common::CSpline<> spline(maths::common::CSplineTypes::E_Cubic);
        spline.interpolate(x, y, maths::common::CSplineTypes::E_ParabolicRunout);
...
BOOST_AUTO_TEST_CASE(testSplineReference) {
    ...
    using TSplineRef = maths::common::CSpline<TFloatVecRef, TFloatVecRef, TDoubleVecRef>;
    ...
    TSplineRef splineRef(maths::common::CSplineTypes::E_Cubic, std::ref(knotsStorage),
                         std::ref(valuesStorage), std::ref(curvaturesStorage));
    splineRef.interpolate(x, y, maths::common::CSplineTypes::E_Natural);
