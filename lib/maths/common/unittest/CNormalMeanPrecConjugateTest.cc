...
BOOST_AUTO_TEST_CASE(testPersist) {
    ...
    core::CJsonStatePersistInserter::persist(
        origJson, std::bind(&maths::common::CNormalMeanPrecConjugate::acceptPersistInserter,
    ...
    core::CJsonStatePersistInserter::persist(
        newJson, std::bind(&maths::common::CNormalMeanPrecConjugate::acceptPersistInserter,
