...
double CStatisticalTests::twoSampleKS(TDoubleVec x, TDoubleVec y) {
    ...
    double neff = std::sqrt(static_cast<double>(nx) * static_cast<double>(ny) /
                            static_cast<double>(nx + ny));
    double result = significance((neff + 0.12 + 0.11 / neff) * D);
    LOG_TRACE(<< "nx = " << nx << ", ny = " << ny << ", D = " << D
              << ", significance = " << result);
    return result;
}
...
const double CStatisticalTests::CCramerVonMises::P_VALUES[16] = {
    0.01, 0.025, 0.05, 0.1, 0.15, 0.2,   0.25, 0.5,
    0.75, 0.8,   0.85, 0.9, 0.95, 0.975, 0.99, 0.999};
...
const double CStatisticalTests::CCramerVonMises::T_VALUES[13][16] = {
    {0.04326, 0.04565, 0.04962, 0.05758, 0.06554, 0.07350, 0.08146, 0.12659,
     0.21522, 0.24743, 0.28854, 0.34343, 0.42480, 0.48901, 0.55058, 0.62858},
    {0.03319, 0.03774, 0.04360, 0.05205, 0.06091, 0.06887, 0.07683, 0.12542,
     0.21338, 0.24167, 0.27960, 0.33785, 0.43939, 0.53318, 0.63980, 0.82240},
    {0.03002, 0.03536, 0.04149, 0.05093, 0.05896, 0.06681, 0.07493, 0.12406,
     0.21171, 0.24260, 0.28336, 0.34184, 0.44206, 0.54200, 0.67017, 0.92970},
    {0.02869, 0.03422, 0.04036, 0.04969, 0.05800, 0.06610, 0.07427, 0.12250,
     0.21164, 0.24237, 0.28305, 0.34238, 0.44697, 0.55056, 0.68352, 0.98730},
    {0.02796, 0.03344, 0.03959, 0.04911, 0.05747, 0.06548, 0.07351, 0.12200,
     0.21110, 0.24198, 0.28331, 0.34352, 0.44911, 0.55572, 0.69443, 1.02000},
    {0.02741, 0.03292, 0.03914, 0.04869, 0.05698, 0.06492, 0.07297, 0.12158,
     0.21087, 0.24197, 0.28345, 0.34397, 0.45100, 0.55935, 0.70154, 1.04250},
    {0.02702, 0.03257, 0.03875, 0.04823, 0.05650, 0.06448, 0.07254, 0.12113,
     0.21065, 0.24186, 0.28356, 0.34458, 0.45240, 0.56220, 0.70720, 1.05910},
    {0.02679, 0.03230, 0.03850, 0.04798, 0.05625, 0.06423, 0.07228, 0.12088,
     0.21051, 0.24179, 0.28361, 0.34487, 0.45367, 0.56493, 0.71233, 1.07220},
    {0.02657, 0.03209, 0.03830, 0.04778, 0.05605, 0.06403, 0.07208, 0.12068,
     0.21040, 0.24173, 0.28365, 0.34510, 0.45441, 0.56643, 0.71531, 1.08220},
    {0.02564, 0.03120, 0.03742, 0.04689, 0.05515, 0.06312, 0.07117, 0.11978,
     0.20989, 0.24148, 0.28384, 0.34617, 0.45778, 0.57331, 0.72895, 1.11898},
    {0.02512, 0.03068, 0.03690, 0.04636, 0.05462, 0.06258, 0.07062, 0.11924,
     0.20958, 0.24132, 0.28396, 0.34682, 0.45986, 0.57754, 0.73728, 1.14507},
    {0.02488, 0.03043, 0.03665, 0.04610, 0.05435, 0.06231, 0.07035, 0.11897,
     0.20943, 0.24125, 0.28402, 0.34715, 0.46091, 0.57968, 0.74149, 1.15783},
    {0.02481, 0.03037, 0.03658, 0.04603, 0.05428, 0.06224, 0.07027, 0.11889,
     0.20938, 0.24123, 0.28403, 0.34724, 0.46119, 0.58026, 0.74262, 1.16120}};
