...
const TTokenListDataTyperKeepsFields::TTokenListReverseSearchCreatorIntfCPtr
...
void CTokenListDataTyperTest::testProxyData(void) {
    ...
    CPPUNIT_ASSERT_EQUAL(1,
                         typer.computeType(false,
                                           " [1094662464] INFO  transaction "
                                           "<3c26701d3140-kn8n1c8f5d2o> - Transaction TID: "
                                           "z9hG4bKy6aEy6aEy6aEaUgi!UmU-Ma.9-6bf50ea0192.168."
                                           "251.8SUBSCRIBE deleted",
                                           500));
    CPPUNIT_ASSERT_EQUAL(1,
                         typer.computeType(false,
                                           " [1091504448] INFO  transaction "
                                           "<3c26701ad775-1cref2zy3w9e> - Transaction TID: "
                                           "z9hG4bK_UQA_UQA_UQAsO0i!OG!yYK.25-5bee09e0192.168."
                                           "251.8SUBSCRIBE deleted",
                                           500));
    CPPUNIT_ASSERT_EQUAL(2,
                         typer.computeType(false,
                                           " [1094662464] INFO  transactionuser "
                                           "<6508700927200972648@10.10.18.82> - ---------------- "
                                           "DESTROYING RegistrationServer ---------------",
                                           500));
    CPPUNIT_ASSERT_EQUAL(3,
                         typer.computeType(false,
                                           " [1111529792] INFO  proxy "
                                           "<45409105041220090733@192.168.251.123> - "
                                           "+++++++++++++++ CREATING ProxyCore ++++++++++++++++",
                                           500));
    CPPUNIT_ASSERT_EQUAL(4,
                         typer.computeType(false,
                                           " [1091504448] INFO  transactionuser "
                                           "<3c26709ab9f0-iih26eh8pxxa> - +++++++++++++++ "
    ...
    CPPUNIT_ASSERT_EQUAL(5,
                         typer.computeType(false,
                                           " [1094662464] INFO  session "
                                           "<ch6z1bho8xeprb3z4ty604iktl6c@dave.proxy.uk> - "
                                           "----------------- PROXY Session DESTROYED "
                                           "--------------------",
                                           500));
}
...
void CTokenListDataTyperTest::testFxData(void) {
    ...
    CPPUNIT_ASSERT_EQUAL(
        ...
        typer.computeType(false,
                          ...
                          "SR=\"co.elastic.session.ejb.FxCoverSessionBean\">javax.ejb."
                          "FinderException - findFxCover([]): null</L_MSG>",
                          500));
    CPPUNIT_ASSERT_EQUAL(
        1,
        typer.computeType(false,
...
void CTokenListDataTyperTest::testBrokerageData(void) {
    ...
    CPPUNIT_ASSERT_EQUAL(
        ...
        typer.computeType(false,
                          ...
                          "REQ4e42023e0a0328d020003e460005aa33; applnx911.elastic.co; ; Request "
                          "Complete: /mlgw/mlb/ofsummary/summary "
                          "[T=283ms,CUSTPREF-WEB_ACCOUNT_PREFERENCES=95,MAUI-ETSPROF2=155,NBMSG-"
                          "NB_MESSAGING_SERVICE=164,CustAcctProfile=BRK=2;NB=0;FILI=0;CESG=0;CC="
                          "0;AcctTotal=2,migrated=2]",
                          500));
    CPPUNIT_ASSERT_EQUAL(
        2,
        typer.computeType(false,
    ...
    CPPUNIT_ASSERT_EQUAL(
        ...
        typer.computeType(false,
                          ...
                          "[T=90ms,CacheStore-GetAttribute=5,MAUI-ECAPPOS=50,RR-QUOTE_"
                          "TRANSACTION=11]",
                          500));
}
...
void CTokenListDataTyperTest::testVmwareData(void) {
    ...
    CPPUNIT_ASSERT_EQUAL(1,
                         typer.computeType(false,
                                           "Vpxa: [49EC0B90 verbose 'VpxaHalCnxHostagent' "
                                           "opID=WFU-ddeadb59] [WaitForUpdatesDone] Received "
                                           "callback",
                                           103));
    CPPUNIT_ASSERT_EQUAL(2,
                         typer.computeType(false,
                                           "Vpxa: [49EC0B90 verbose 'Default' opID=WFU-ddeadb59] "
                                           "[VpxaHalVmHostagent] 11: GuestInfo changed 'guest.disk",
                                           107));
    CPPUNIT_ASSERT_EQUAL(3,
                         typer.computeType(false,
                                           "Vpxa: [49EC0B90 verbose 'VpxaHalCnxHostagent' "
                                           "opID=WFU-ddeadb59] [WaitForUpdatesDone] Completed "
                                           "callback",
                                           104));
    CPPUNIT_ASSERT_EQUAL(1,
                         typer.computeType(false,
                                           "Vpxa: [49EC0B90 verbose 'VpxaHalCnxHostagent' "
                                           "opID=WFU-35689729] [WaitForUpdatesDone] Received "
                                           "callback",
                                           103));
    CPPUNIT_ASSERT_EQUAL(2,
                         typer.computeType(false,
                                           "Vpxa: [49EC0B90 verbose 'Default' opID=WFU-35689729] "
                                           "[VpxaHalVmHostagent] 15: GuestInfo changed 'guest.disk",
                                           107));
    CPPUNIT_ASSERT_EQUAL(3,
                         typer.computeType(false,
                                           "Vpxa: [49EC0B90 verbose 'VpxaHalCnxHostagent' "
                                           "opID=WFU-35689729] [WaitForUpdatesDone] Completed "
                                           "callback",
                                           104));
}
...
void CTokenListDataTyperTest::testBankData(void) {
    ...
    CPPUNIT_ASSERT_EQUAL(1,
                         typer.computeType(false,
                                           "INFO  "
                                           "[co.elastic.settlement.synchronization."
                                           "PaymentFlowProcessorImpl] Process payment flow for "
                                           "tradeId=80894728 and backOfficeId=9354474",
                                           500));
    CPPUNIT_ASSERT_EQUAL(2,
                         typer.computeType(false,
                                           "INFO  "
                                           "[co.elastic.settlement.synchronization."
                                           "PaymentFlowProcessorImpl] Synchronization of "
                                           "payment flow is complete for tradeId=80013186 and "
                                           "backOfficeId=265573",
                                           500));
    ...
    CPPUNIT_ASSERT_EQUAL(1,
                         typer.computeType(false,
                                           "INFO  "
                                           "[co.elastic.settlement.synchronization."
                                           "PaymentFlowProcessorImpl] Synchronize payment flow "
                                           "for tradeId=80894721 and backOfficeId=9354469",
                                           500));
}
...
void CTokenListDataTyperTest::testJavaGcData(void) {
    ...
    CPPUNIT_ASSERT_EQUAL(2,
                         typer.computeType(false,
                                           "PSYoungGen      total 2572800K, used 1759355K "
                                           "[0x0000000759500000, 0x0000000800000000, "
                                           "0x0000000800000000)",
                                           106));
    CPPUNIT_ASSERT_EQUAL(2,
                         typer.computeType(false,
                                           "PSYoungGen      total 2572801K, used 1759355K "
                                           "[0x0000000759500000, 0x0000000800000000, "
                                           "0x0000000800000000)",
                                           106));
    CPPUNIT_ASSERT_EQUAL(2,
                         typer.computeType(false,
                                           "PSYoungGen      total 2572802K, used 1759355K "
                                           "[0x0000000759500000, 0x0000000800000000, "
                                           "0x0000000800000000)",
                                           106));
    CPPUNIT_ASSERT_EQUAL(2,
                         typer.computeType(false,
                                           "PSYoungGen      total 2572803K, used 1759355K "
                                           "[0x0000000759500000, 0x0000000800000000, "
                                           "0x0000000800000000)",
                                           106));
    CPPUNIT_ASSERT_EQUAL(2,
                         typer.computeType(false,
                                           "PSYoungGen      total 2572803K, used 1759355K "
                                           "[0x0000000759600000, 0x0000000800000000, "
                                           "0x0000000800000000)",
                                           106));
    CPPUNIT_ASSERT_EQUAL(2,
                         typer.computeType(false,
                                           "PSYoungGen      total 2572803K, used 1759355K "
                                           "[0x0000000759700000, 0x0000000800000000, "
                                           "0x0000000800000000)",
                                           106));
    CPPUNIT_ASSERT_EQUAL(2,
                         typer.computeType(false,
                                           "PSYoungGen      total 2572803K, used 1759355K "
                                           "[0x0000000759800000, 0x0000000800000000, "
                                           "0x0000000800000000)",
                                           106));
}
...
void CTokenListDataTyperTest::testPreTokenisedPerformance(void) {
    ...
    uint64_t inlineTokenisationTime(0);
    {
        ...
        for (size_t count = 0; count < TEST_SIZE; ++count) {
            CPPUNIT_ASSERT_EQUAL(1,
                                 typer.computeType(false,
                                                   "Vpxa: [49EC0B90 verbose "
                                                   "'VpxaHalCnxHostagent' opID=WFU-ddeadb59] "
