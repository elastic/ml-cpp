...
BOOST_AUTO_TEST_CASE(testRmdsData) {
    ...
    BOOST_REQUIRE_EQUAL(1, typer.computeType(false, "<ml13-4608.1.p2ps: Info: > Source ML_SERVICE2 on 13122:867 has shut down.",
                                           500));
    BOOST_REQUIRE_EQUAL(1, typer.computeType(false, "<ml13-4602.1.p2ps: Info: > Source MONEYBROKER on 13112:736 has shut down.",
                                           500));
    BOOST_REQUIRE_EQUAL(1, typer.computeType(false, "<ml13-4606.1.p2ps: Info: > Source CUBE_LIQUID on 13188:2010 has shut down.",
                                           500));
    BOOST_REQUIRE_EQUAL(1, typer.computeType(false, "<ml13-4608.1.p2ps: Info: > Source ML SERVICE2 on 13122:867 has shut down.",
                                           500));
    BOOST_REQUIRE_EQUAL(2, typer.computeType(false, "<ml13-4602.1.p2ps: Info: > Source MONEYBROKER on 13112:736 has started.",
                                           500));
    BOOST_REQUIRE_EQUAL(2, typer.computeType(false, "<ml13-4608.1.p2ps: Info: > Source ML_SERVICE2 on 13122:867 has started.",
                                           500));
    BOOST_REQUIRE_EQUAL(3, typer.computeType(false, "<ml00-4201.1.p2ps: Info: > Service CUBE_CHIX, id of 132, has started.",
                                           500));
    BOOST_REQUIRE_EQUAL(3, typer.computeType(false, "<ml00-4601.1.p2ps: Info: > Service CUBE_IDEM, id of 232, has started.",
                                           500));
    BOOST_REQUIRE_EQUAL(3, typer.computeType(false, "<ml00-4601.1.p2ps: Info: > Service CUBE_IDEM, id of 232, has started.",
                                           500));
    BOOST_REQUIRE_EQUAL(4, typer.computeType(false, "<ml00-4201.1.p2ps: Info: > Service CUBE_CHIX has shut down.",
                                           500));
}
...
BOOST_AUTO_TEST_CASE(testProxyData) {
    ...
    BOOST_REQUIRE_EQUAL(1, typer.computeType(false,
                                           ...
                                           500));
    BOOST_REQUIRE_EQUAL(2, typer.computeType(false,
                                           " [1094662464] INFO  transactionuser <6508700927200972648@10.10.18.82> - ---------------- "
                                           "DESTROYING RegistrationServer ---------------",
                                           500));
    BOOST_REQUIRE_EQUAL(3, typer.computeType(false, " [1111529792] INFO  proxy <45409105041220090733@192.168.251.123> - +++++++++++++++ CREATING ProxyCore ++++++++++++++++",
                                           500));
    BOOST_REQUIRE_EQUAL(4, typer.computeType(false, " [1091504448] INFO  transactionuser <3c26709ab9f0-iih26eh8pxxa> - +++++++++++++++ CREATING PresenceAgent ++++++++++++++++",
                                           500));
    BOOST_REQUIRE_EQUAL(5, typer.computeType(false,
...
BOOST_AUTO_TEST_CASE(testApacheData) {
    ...
    BOOST_REQUIRE_EQUAL(1, typer.computeType(false, " org.apache.coyote.http11.Http11BaseProtocol destroy",
                                           500));
    BOOST_REQUIRE_EQUAL(2, typer.computeType(false, " org.apache.coyote.http11.Http11BaseProtocol init",
                                           500));
    BOOST_REQUIRE_EQUAL(3, typer.computeType(false, " org.apache.coyote.http11.Http11BaseProtocol start",
                                           500));
    BOOST_REQUIRE_EQUAL(4, typer.computeType(false, " org.apache.coyote.http11.Http11BaseProtocol stop",
                                           500));
}
...
BOOST_AUTO_TEST_CASE(testBrokerageData) {
    ...
    BOOST_REQUIRE_EQUAL(2, typer.computeType(false,
                                           ...
                                           500));
    BOOST_REQUIRE_EQUAL(3, typer.computeType(false,
...
BOOST_AUTO_TEST_CASE(testVmwareData) {
    ...
    BOOST_REQUIRE_EQUAL(1, typer.computeType(false, "Vpxa: [49EC0B90 verbose 'VpxaHalCnxHostagent' opID=WFU-ddeadb59] [WaitForUpdatesDone] Received callback",
                                           103));
    BOOST_REQUIRE_EQUAL(2, typer.computeType(false, "Vpxa: [49EC0B90 verbose 'Default' opID=WFU-ddeadb59] [VpxaHalVmHostagent] 11: GuestInfo changed 'guest.disk",
                                           107));
    BOOST_REQUIRE_EQUAL(3, typer.computeType(false, "Vpxa: [49EC0B90 verbose 'VpxaHalCnxHostagent' opID=WFU-ddeadb59] [WaitForUpdatesDone] Completed callback",
                                           104));
    BOOST_REQUIRE_EQUAL(1, typer.computeType(false, "Vpxa: [49EC0B90 verbose 'VpxaHalCnxHostagent' opID=WFU-35689729] [WaitForUpdatesDone] Received callback",
                                           103));
    BOOST_REQUIRE_EQUAL(2, typer.computeType(false, "Vpxa: [49EC0B90 verbose 'Default' opID=WFU-35689729] [VpxaHalVmHostagent] 15: GuestInfo changed 'guest.disk",
                                           107));
    BOOST_REQUIRE_EQUAL(3, typer.computeType(false, "Vpxa: [49EC0B90 verbose 'VpxaHalCnxHostagent' opID=WFU-35689729] [WaitForUpdatesDone] Completed callback",
                                           104));
}
...
BOOST_AUTO_TEST_CASE(testJavaGcData) {
    ...
    BOOST_REQUIRE_EQUAL(1, typer.computeType(false, "2016-04-27T19:57:43.644-0700: 1922084.903: [GC",
                                           46));
    BOOST_REQUIRE_EQUAL(1, typer.computeType(false, "2016-04-28T19:57:43.644-0700: 1922084.903: [GC",
                                           46));
    BOOST_REQUIRE_EQUAL(1, typer.computeType(false, "2016-04-29T19:57:43.644-0700: 1922084.903: [GC",
                                           46));
    BOOST_REQUIRE_EQUAL(1, typer.computeType(false, "2016-04-30T19:57:43.644-0700: 1922084.903: [GC",
                                           46));
    BOOST_REQUIRE_EQUAL(1, typer.computeType(false, "2016-04-30T19:57:43.644-0700: 1922084.904: [GC",
                                           46));
    BOOST_REQUIRE_EQUAL(1, typer.computeType(false, "2016-04-30T19:57:43.644-0700: 1922084.905: [GC",
                                           46));
    BOOST_REQUIRE_EQUAL(1, typer.computeType(false, "2016-04-30T19:57:43.644-0700: 1922084.906: [GC",
                                           46));
    BOOST_REQUIRE_EQUAL(1, typer.computeType(false, "2016-04-30T19:57:43.644-0700: 1922085.906: [GC",
                                           46));
    BOOST_REQUIRE_EQUAL(1, typer.computeType(false, "2016-04-30T19:57:43.644-0700: 1922086.906: [GC",
                                           46));
    BOOST_REQUIRE_EQUAL(1, typer.computeType(false, "2016-04-30T19:57:43.644-0700: 1922087.906: [GC",
                                           46));
    BOOST_REQUIRE_EQUAL(1, typer.computeType(false, "2016-04-30T19:57:43.645-0700: 1922087.906: [GC",
                                           46));
    BOOST_REQUIRE_EQUAL(1, typer.computeType(false, "2016-04-30T19:57:43.646-0700: 1922087.906: [GC",
                                           46));
    BOOST_REQUIRE_EQUAL(1, typer.computeType(false, "2016-04-30T19:57:43.647-0700: 1922087.906: [GC",
                                           46));

    BOOST_REQUIRE_EQUAL(2, typer.computeType(false, "PSYoungGen      total 2572800K, used 1759355K [0x0000000759500000, 0x0000000800000000, 0x0000000800000000)",
                                           106));
    BOOST_REQUIRE_EQUAL(2, typer.computeType(false, "PSYoungGen      total 2572801K, used 1759355K [0x0000000759500000, 0x0000000800000000, 0x0000000800000000)",
                                           106));
    BOOST_REQUIRE_EQUAL(2, typer.computeType(false, "PSYoungGen      total 2572802K, used 1759355K [0x0000000759500000, 0x0000000800000000, 0x0000000800000000)",
                                           106));
    BOOST_REQUIRE_EQUAL(2, typer.computeType(false, "PSYoungGen      total 2572803K, used 1759355K [0x0000000759500000, 0x0000000800000000, 0x0000000800000000)",
                                           106));
    BOOST_REQUIRE_EQUAL(2, typer.computeType(false, "PSYoungGen      total 2572803K, used 1759355K [0x0000000759600000, 0x0000000800000000, 0x0000000800000000)",
                                           106));
    BOOST_REQUIRE_EQUAL(2, typer.computeType(false, "PSYoungGen      total 2572803K, used 1759355K [0x0000000759700000, 0x0000000800000000, 0x0000000800000000)",
                                           106));
    BOOST_REQUIRE_EQUAL(2, typer.computeType(false, "PSYoungGen      total 2572803K, used 1759355K [0x0000000759800000, 0x0000000800000000, 0x0000000800000000)",
                                           106));
}
...
BOOST_AUTO_TEST_CASE(testLongReverseSearch) {
    ...
    BOOST_TEST_REQUIRE(typer.createReverseSearch(type, terms, regex, maxMatchingLength, wasCached));
...
BOOST_AUTO_TEST_CASE(testPreTokenised) {
    ...
    BOOST_REQUIRE_EQUAL(4, typer.computeType(false, fields, "<ml00-4201.1.p2ps: Info: > Service CUBE_CHIX has shut down.",
                                           500));
    ...
    BOOST_REQUIRE_EQUAL(1, typer.computeType(false, fields, "<ml00-4201.1.p2ps: Info: > Service CUBE_CHIX has shut down.",
                                           500));
    ...
    BOOST_REQUIRE_EQUAL(5, typer.computeType(false, fields, "<ml00-4201.1.p2ps: Info: > Service CUBE_CHIX has shut down.",
                                           500));
}
...
BOOST_AUTO_TEST_CASE(testPreTokenisedPerformance) {
    ...
    uint64_t preTokenisationTime(0);
    {
        ...
        stopWatch.start();
        for (size_t count = 0; count < TEST_SIZE; ++count) {
            BOOST_REQUIRE_EQUAL(1, typer.computeType(false, fields, "Vpxa: [49EC0B90 verbose 'VpxaHalCnxHostagent' opID=WFU-ddeadb59] [WaitForUpdatesDone] Received callback",
                                                   103));
        }
