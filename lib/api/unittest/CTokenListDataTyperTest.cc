...
CppUnit::Test* CTokenListDataTyperTest::suite() {
    ...
    suiteOfTests->addTest(new CppUnit::TestCaller<CTokenListDataTyperTest>("CTokenListDataTyperTest::testHexData",
                                                                           &CTokenListDataTyperTest::testHexData));
    suiteOfTests->addTest(new CppUnit::TestCaller<CTokenListDataTyperTest>("CTokenListDataTyperTest::testRmdsData",
    ...
    suiteOfTests->addTest(new CppUnit::TestCaller<CTokenListDataTyperTest>("CTokenListDataTyperTest::testFxData",
    ...
    suiteOfTests->addTest(new CppUnit::TestCaller<CTokenListDataTyperTest>("CTokenListDataTyperTest::testBankData",
    ...
    suiteOfTests->addTest(new CppUnit::TestCaller<CTokenListDataTyperTest>("CTokenListDataTyperTest::testPersist",
                                                                           &CTokenListDataTyperTest::testPersist));
    suiteOfTests->addTest(new CppUnit::TestCaller<CTokenListDataTyperTest>(
        "CTokenListDataTyperTest::testLongReverseSearch", &CTokenListDataTyperTest::testLongReverseSearch));
    ...
    suiteOfTests->addTest(new CppUnit::TestCaller<CTokenListDataTyperTest>(
        "CTokenListDataTyperTest::testPreTokenisedPerformance", &CTokenListDataTyperTest::testPreTokenisedPerformance));
...
void CTokenListDataTyperTest::testRmdsData(void) {
    ...
    CPPUNIT_ASSERT_EQUAL(
        1, typer.computeType(false, "<ml13-4608.1.p2ps: Info: > Source ML_SERVICE2 on 13122:867 has shut down.", 500));
    CPPUNIT_ASSERT_EQUAL(
        1, typer.computeType(false, "<ml13-4602.1.p2ps: Info: > Source MONEYBROKER on 13112:736 has shut down.", 500));
    CPPUNIT_ASSERT_EQUAL(
        1, typer.computeType(false, "<ml13-4606.1.p2ps: Info: > Source CUBE_LIQUID on 13188:2010 has shut down.", 500));
    CPPUNIT_ASSERT_EQUAL(
        1, typer.computeType(false, "<ml13-4608.1.p2ps: Info: > Source ML SERVICE2 on 13122:867 has shut down.", 500));
    CPPUNIT_ASSERT_EQUAL(
        2, typer.computeType(false, "<ml13-4602.1.p2ps: Info: > Source MONEYBROKER on 13112:736 has started.", 500));
    CPPUNIT_ASSERT_EQUAL(
        2, typer.computeType(false, "<ml13-4608.1.p2ps: Info: > Source ML_SERVICE2 on 13122:867 has started.", 500));
    CPPUNIT_ASSERT_EQUAL(
        3, typer.computeType(false, "<ml00-4201.1.p2ps: Info: > Service CUBE_CHIX, id of 132, has started.", 500));
    CPPUNIT_ASSERT_EQUAL(
        3, typer.computeType(false, "<ml00-4601.1.p2ps: Info: > Service CUBE_IDEM, id of 232, has started.", 500));
    CPPUNIT_ASSERT_EQUAL(
        3, typer.computeType(false, "<ml00-4601.1.p2ps: Info: > Service CUBE_IDEM, id of 232, has started.", 500));
    CPPUNIT_ASSERT_EQUAL(4,
                         typer.computeType(false, "<ml00-4201.1.p2ps: Info: > Service CUBE_CHIX has shut down.", 500));
}
...
void CTokenListDataTyperTest::testPersist(void) {
    ...
    TTokenListDataTyperKeepsFields restoredTyper(NO_REVERSE_SEARCH_CREATOR, 0.7, "whatever");
    {
        ...
        CPPUNIT_ASSERT(traverser.traverseSubLevel(
            boost::bind(&TTokenListDataTyperKeepsFields::acceptRestoreTraverser, &restoredTyper, _1)));
    }
...
void CTokenListDataTyperTest::testPreTokenised(void) {
    ...
    CPPUNIT_ASSERT_EQUAL(
        4, typer.computeType(false, fields, "<ml00-4201.1.p2ps: Info: > Service CUBE_CHIX has shut down.", 500));
    ...
    CPPUNIT_ASSERT_EQUAL(
        1, typer.computeType(false, fields, "<ml00-4201.1.p2ps: Info: > Service CUBE_CHIX has shut down.", 500));
    ...
    CPPUNIT_ASSERT_EQUAL(
        5, typer.computeType(false, fields, "<ml00-4201.1.p2ps: Info: > Service CUBE_CHIX has shut down.", 500));
}
