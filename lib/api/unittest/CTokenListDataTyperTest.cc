...
CppUnit::Test* CTokenListDataTyperTest::suite() {
    ...
    suiteOfTests->addTest(
        new CppUnit::TestCaller<CTokenListDataTyperTest>("CTokenListDataTyperTest::testHexData", &CTokenListDataTyperTest::testHexData));
    suiteOfTests->addTest(
        new CppUnit::TestCaller<CTokenListDataTyperTest>("CTokenListDataTyperTest::testRmdsData", &CTokenListDataTyperTest::testRmdsData));
    suiteOfTests->addTest(new CppUnit::TestCaller<CTokenListDataTyperTest>("CTokenListDataTyperTest::testProxyData",
                                                                           &CTokenListDataTyperTest::testProxyData));
    suiteOfTests->addTest(
        new CppUnit::TestCaller<CTokenListDataTyperTest>("CTokenListDataTyperTest::testFxData", &CTokenListDataTyperTest::testFxData));
    suiteOfTests->addTest(new CppUnit::TestCaller<CTokenListDataTyperTest>("CTokenListDataTyperTest::testApacheData",
                                                                           &CTokenListDataTyperTest::testApacheData));
    suiteOfTests->addTest(new CppUnit::TestCaller<CTokenListDataTyperTest>("CTokenListDataTyperTest::testBrokerageData",
                                                                           &CTokenListDataTyperTest::testBrokerageData));
    suiteOfTests->addTest(new CppUnit::TestCaller<CTokenListDataTyperTest>("CTokenListDataTyperTest::testVmwareData",
                                                                           &CTokenListDataTyperTest::testVmwareData));
    suiteOfTests->addTest(
        new CppUnit::TestCaller<CTokenListDataTyperTest>("CTokenListDataTyperTest::testBankData", &CTokenListDataTyperTest::testBankData));
    suiteOfTests->addTest(new CppUnit::TestCaller<CTokenListDataTyperTest>("CTokenListDataTyperTest::testJavaGcData",
                                                                           &CTokenListDataTyperTest::testJavaGcData));
    suiteOfTests->addTest(
        new CppUnit::TestCaller<CTokenListDataTyperTest>("CTokenListDataTyperTest::testPersist", &CTokenListDataTyperTest::testPersist));
    suiteOfTests->addTest(new CppUnit::TestCaller<CTokenListDataTyperTest>("CTokenListDataTyperTest::testLongReverseSearch",
                                                                           &CTokenListDataTyperTest::testLongReverseSearch));
    suiteOfTests->addTest(new CppUnit::TestCaller<CTokenListDataTyperTest>("CTokenListDataTyperTest::testPreTokenised",
                                                                           &CTokenListDataTyperTest::testPreTokenised));
    suiteOfTests->addTest(new CppUnit::TestCaller<CTokenListDataTyperTest>("CTokenListDataTyperTest::testPreTokenisedPerformance",
...
void CTokenListDataTyperTest::testRmdsData(void) {
    ...
    CPPUNIT_ASSERT_EQUAL(1, typer.computeType(false, "<ml13-4602.1.p2ps: Info: > Source MONEYBROKER on 13112:736 has shut down.", 500));
    CPPUNIT_ASSERT_EQUAL(1, typer.computeType(false, "<ml13-4606.1.p2ps: Info: > Source CUBE_LIQUID on 13188:2010 has shut down.", 500));
    CPPUNIT_ASSERT_EQUAL(1, typer.computeType(false, "<ml13-4608.1.p2ps: Info: > Source ML SERVICE2 on 13122:867 has shut down.", 500));
    CPPUNIT_ASSERT_EQUAL(2, typer.computeType(false, "<ml13-4602.1.p2ps: Info: > Source MONEYBROKER on 13112:736 has started.", 500));
    CPPUNIT_ASSERT_EQUAL(2, typer.computeType(false, "<ml13-4608.1.p2ps: Info: > Source ML_SERVICE2 on 13122:867 has started.", 500));
    CPPUNIT_ASSERT_EQUAL(3, typer.computeType(false, "<ml00-4201.1.p2ps: Info: > Service CUBE_CHIX, id of 132, has started.", 500));
    CPPUNIT_ASSERT_EQUAL(3, typer.computeType(false, "<ml00-4601.1.p2ps: Info: > Service CUBE_IDEM, id of 232, has started.", 500));
    CPPUNIT_ASSERT_EQUAL(3, typer.computeType(false, "<ml00-4601.1.p2ps: Info: > Service CUBE_IDEM, id of 232, has started.", 500));
...
void CTokenListDataTyperTest::testPersist(void) {
    ...
    origTyper.computeType(false, "<ml13-4602.1.p2ps: Info: > Source MONEYBROKER on 13112:736 has shut down.", 500);
    origTyper.computeType(false, "<ml13-4606.1.p2ps: Info: > Source CUBE_LIQUID on 13188:2010 has shut down.", 500);
    origTyper.computeType(false, "<ml13-4608.1.p2ps: Info: > Source ML SERVICE2 on 13122:867 has shut down.", 500);
    origTyper.computeType(false, "<ml13-4602.1.p2ps: Info: > Source MONEYBROKER on 13112:736 has started.", 500);
    origTyper.computeType(false, "<ml13-4608.1.p2ps: Info: > Source ML_SERVICE2 on 13122:867 has started.", 500);
    origTyper.computeType(false, "<ml00-4201.1.p2ps: Info: > Service CUBE_CHIX, id of 132, has started.", 500);
    origTyper.computeType(false, "<ml00-4601.1.p2ps: Info: > Service CUBE_IDEM, id of 232, has started.", 500);
    origTyper.computeType(false, "<ml00-4601.1.p2ps: Info: > Service CUBE_IDEM, id of 232, has started.", 500);
    origTyper.computeType(false, "<ml00-4201.1.p2ps: Info: > Service CUBE_CHIX has shut down.", 500);
    ...
    TTokenListDataTyperKeepsFields restoredTyper(NO_REVERSE_SEARCH_CREATOR, 0.7, "whatever");
    {
        ...
        CPPUNIT_ASSERT(
            traverser.traverseSubLevel(boost::bind(&TTokenListDataTyperKeepsFields::acceptRestoreTraverser, &restoredTyper, _1)));
    }
...
void CTokenListDataTyperTest::testPreTokenised(void) {
    ...
    fields[TTokenListDataTyperKeepsFields::PRETOKENISED_TOKEN_FIELD] = "ml00-4201.1.p2ps,Info,Service,CUBE_CHIX,has,shut,down";
    CPPUNIT_ASSERT_EQUAL(4, typer.computeType(false, fields, "<ml00-4201.1.p2ps: Info: > Service CUBE_CHIX has shut down.", 500));
    ...
    fields[TTokenListDataTyperKeepsFields::PRETOKENISED_TOKEN_FIELD] = "ml13-4608.1.p2ps,Info,Source,ML_SERVICE2,on,has,shut,down";
    CPPUNIT_ASSERT_EQUAL(1, typer.computeType(false, fields, "<ml00-4201.1.p2ps: Info: > Service CUBE_CHIX has shut down.", 500));
