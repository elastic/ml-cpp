...
BOOST_AUTO_TEST_CASE(testInitNormalizerPartitioned) {
    ...
    BOOST_TEST(normalizer.initNormalizer("testfiles/new_quantilesState.json"));
    ...
    BOOST_TEST(inputParser.readStreamIntoMaps(std::bind(
    ...
    BOOST_CHECK_EQUAL(std::vector<rapidjson::Document>::size_type{327},
                      resultDocs.size());
    ...
    // score which is 90.69091
    {
        ...
        BOOST_CHECK_EQUAL(std::string(""), std::string(doc["function_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("2.1305076675260463E-24"),
        ...
        BOOST_CHECK_EQUAL(std::string("root"), std::string(doc["level"].GetString()));
        BOOST_CHECK_EQUAL(std::string("90.69091"),
    ...
    }
    {
        ...
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["value_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""), std::string(doc["function_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("1.90875417733942E-22"),
                          std::string(doc["probability"].GetString()));
        ...
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["partition_field_value"].GetString()));
        BOOST_CHECK_EQUAL(std::string("inflb"), std::string(doc["level"].GetString()));
        BOOST_CHECK_EQUAL(std::string("69.60219"),
                          std::string(doc["normalized_score"].GetString()));
    }
    {
        ...
        BOOST_CHECK_EQUAL(std::string("0.003824460431046938"),
                          std::string(doc["probability"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["person_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
        ...
        BOOST_CHECK_EQUAL(std::string("airline"),
                          std::string(doc["partition_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("ASA"),
                          std::string(doc["partition_field_value"].GetString()));
        BOOST_CHECK_EQUAL(std::string("leaf"), std::string(doc["level"].GetString()));
        BOOST_CHECK_EQUAL(std::string("44.29573"),
                          std::string(doc["normalized_score"].GetString()));
    }
    {
        ...
        BOOST_CHECK_EQUAL(std::string("high_mean"),
                          std::string(doc["function_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("0.035787369763616045"),
                          std::string(doc["probability"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["person_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
        ...
        BOOST_CHECK_EQUAL(std::string("airline"),
                          std::string(doc["partition_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("FFT"),
                          std::string(doc["partition_field_value"].GetString()));
        BOOST_CHECK_EQUAL(std::string("leaf"), std::string(doc["level"].GetString()));
    ...
    }
    {
        ...
        BOOST_CHECK_EQUAL(std::string("high_mean"),
                          std::string(doc["function_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("0.013241693005461058"),
                          std::string(doc["probability"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["person_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
        ...
        BOOST_CHECK_EQUAL(std::string("airline"),
                          std::string(doc["partition_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("SWA"),
                          std::string(doc["partition_field_value"].GetString()));
        BOOST_CHECK_EQUAL(std::string("leaf"), std::string(doc["level"].GetString()));
        BOOST_CHECK_EQUAL(std::string("25.31053"),
                          std::string(doc["normalized_score"].GetString()));
    }
    {
        ...
        BOOST_CHECK_EQUAL(std::string("high_mean"),
                          std::string(doc["function_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("4.026858488865555E-4"),
                          std::string(doc["probability"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["person_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
        ...
        BOOST_CHECK_EQUAL(std::string("airline"),
                          std::string(doc["partition_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("TRS"),
                          std::string(doc["partition_field_value"].GetString()));
        BOOST_CHECK_EQUAL(std::string("leaf"), std::string(doc["level"].GetString()));
        BOOST_CHECK_EQUAL(std::string("78.70602"),
                          std::string(doc["normalized_score"].GetString()));
    }
    {
        ...
        BOOST_CHECK_EQUAL(std::string("high_mean"),
                          std::string(doc["function_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("0.0014127543730254476"),
                          std::string(doc["probability"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["person_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
        ...
        BOOST_CHECK_EQUAL(std::string("airline"),
                          std::string(doc["partition_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("UAL"),
                          std::string(doc["partition_field_value"].GetString()));
        BOOST_CHECK_EQUAL(std::string("leaf"), std::string(doc["level"].GetString()));
        BOOST_CHECK_EQUAL(std::string("59.51925"),
                          std::string(doc["normalized_score"].GetString()));
    }
    {
        ...
        BOOST_CHECK_EQUAL(std::string("high_mean"),
                          std::string(doc["function_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("4.440295404321955E-4"),
                          std::string(doc["probability"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["person_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
        ...
        BOOST_CHECK_EQUAL(std::string("airline"),
                          std::string(doc["partition_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("JAL"),
                          std::string(doc["partition_field_value"].GetString()));
        BOOST_CHECK_EQUAL(std::string("leaf"), std::string(doc["level"].GetString()));
        BOOST_CHECK_EQUAL(std::string("77.212"),
                          std::string(doc["normalized_score"].GetString()));
    }
    {
        ...
        BOOST_CHECK_EQUAL(std::string("high_mean"),
                          std::string(doc["function_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("0.011347202666523165"),
                          std::string(doc["probability"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["person_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
        ...
        BOOST_CHECK_EQUAL(std::string("airline"),
                          std::string(doc["partition_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("EGF"),
                          std::string(doc["partition_field_value"].GetString()));
        BOOST_CHECK_EQUAL(std::string("leaf"), std::string(doc["level"].GetString()));
        BOOST_CHECK_EQUAL(std::string("27.67076"),
                          std::string(doc["normalized_score"].GetString()));
    }
    {
        ...
        BOOST_CHECK_EQUAL(std::string("high_mean"),
                          std::string(doc["function_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("7.891442535915233E-31"),
                          std::string(doc["probability"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["person_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
        ...
        BOOST_CHECK_EQUAL(std::string("airline"),
                          std::string(doc["partition_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("AAL"),
                          std::string(doc["partition_field_value"].GetString()));
        BOOST_CHECK_EQUAL(std::string("leaf"), std::string(doc["level"].GetString()));
        BOOST_CHECK_EQUAL(std::string("99.22667"),
                          std::string(doc["normalized_score"].GetString()));
    }
    {
        ...
        BOOST_CHECK_EQUAL(std::string("high_mean"),
                          std::string(doc["function_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("0.0300716991931514"),
                          std::string(doc["probability"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["person_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
        ...
        BOOST_CHECK_EQUAL(std::string("EGF"),
                          std::string(doc["partition_field_value"].GetString()));
        BOOST_CHECK_EQUAL(std::string("leaf"), std::string(doc["level"].GetString()));
        BOOST_CHECK_EQUAL(std::string("8.178497"),
                          std::string(doc["normalized_score"].GetString()));
    }
    {
        ...
        BOOST_CHECK_EQUAL(std::string("high_mean"),
                          std::string(doc["function_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("0.008751921671499477"),
                          std::string(doc["probability"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["person_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
        ...
        BOOST_CHECK_EQUAL(std::string("airline"),
                          std::string(doc["partition_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("KLM"),
                          std::string(doc["partition_field_value"].GetString()));
        BOOST_CHECK_EQUAL(std::string("leaf"), std::string(doc["level"].GetString()));
        BOOST_CHECK_EQUAL(std::string("25.34066"),
                          std::string(doc["normalized_score"].GetString()));
    }
    {
        ...
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["value_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""), std::string(doc["function_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("5.538073913329369E-4"),
                          std::string(doc["probability"].GetString()));
        BOOST_CHECK_EQUAL(std::string("airline"),
                          std::string(doc["person_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("JAL"),
        ...
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["partition_field_value"].GetString()));
        BOOST_CHECK_EQUAL(std::string("infl"), std::string(doc["level"].GetString()));
        BOOST_CHECK_EQUAL(std::string("73.8348"),
                          std::string(doc["normalized_score"].GetString()));
    }
    {
        ...
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["value_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""), std::string(doc["function_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("0.009557853111806711"),
                          std::string(doc["probability"].GetString()));
        BOOST_CHECK_EQUAL(std::string("airline"),
                          std::string(doc["person_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("EGF"),
        ...
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["partition_field_value"].GetString()));
        BOOST_CHECK_EQUAL(std::string("infl"), std::string(doc["level"].GetString()));
        BOOST_CHECK_EQUAL(std::string("30.29406"),
                          std::string(doc["normalized_score"].GetString()));
    }
    {
        ...
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["value_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""), std::string(doc["function_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("1.8102856956640726E-23"),
                          std::string(doc["probability"].GetString()));
        BOOST_CHECK_EQUAL(std::string("airline"),
                          std::string(doc["person_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("AAL"),
        ...
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["partition_field_value"].GetString()));
        BOOST_CHECK_EQUAL(std::string("infl"), std::string(doc["level"].GetString()));
        BOOST_CHECK_EQUAL(std::string("96.89889"),
                          std::string(doc["normalized_score"].GetString()));
    }
    {
        ...
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["value_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""), std::string(doc["function_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("0.0021402294772877688"),
                          std::string(doc["probability"].GetString()));
        BOOST_CHECK_EQUAL(std::string("airline"),
                          std::string(doc["person_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("KLM"),
        ...
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["partition_field_value"].GetString()));
        BOOST_CHECK_EQUAL(std::string("infl"), std::string(doc["level"].GetString()));
        BOOST_CHECK_EQUAL(std::string("53.16964"),
                          std::string(doc["normalized_score"].GetString()));
    }
}
...
BOOST_AUTO_TEST_CASE(testInitNormalizer) {
    ...
    BOOST_TEST(normalizer.initNormalizer("testfiles/quantilesState.json"));
    ...
    BOOST_CHECK_EQUAL(std::vector<rapidjson::Document>::size_type{38},
                      resultDocs.size());
    ...
    // score which is 98.28496
    {
        ...
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["value_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""), std::string(doc["function_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("2.56098e-205"),
                          std::string(doc["probability"].GetString()));
        BOOST_CHECK_EQUAL(std::string("bucketTime"),
                          std::string(doc["person_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["partition_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("root"), std::string(doc["level"].GetString()));
        BOOST_CHECK_EQUAL(std::string("98.28496"),
                          std::string(doc["normalized_score"].GetString()));
    }
    {
        ...
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["value_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""), std::string(doc["function_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("2.93761e-203"),
                          std::string(doc["probability"].GetString()));
        BOOST_CHECK_EQUAL(std::string("status"),
                          std::string(doc["person_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["partition_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("inflb"), std::string(doc["level"].GetString()));
        BOOST_CHECK_EQUAL(std::string("97.26764"),
                          std::string(doc["normalized_score"].GetString()));
    }
    {
        ...
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["value_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""), std::string(doc["function_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("5.56572e-204"),
                          std::string(doc["probability"].GetString()));
        BOOST_CHECK_EQUAL(std::string("status"),
                          std::string(doc["person_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["partition_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("infl"), std::string(doc["level"].GetString()));
        BOOST_CHECK_EQUAL(std::string("98.56057"),
                          std::string(doc["normalized_score"].GetString()));
    }
    {
        ...
        BOOST_CHECK_EQUAL(std::string("count"),
                          std::string(doc["function_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("1e-300"),
                          std::string(doc["probability"].GetString()));
        BOOST_CHECK_EQUAL(std::string("status"),
                          std::string(doc["person_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["partition_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("leaf"), std::string(doc["level"].GetString()));
        BOOST_CHECK_EQUAL(std::string("99.19481"),
                          std::string(doc["normalized_score"].GetString()));
    }
    {
        ...
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["value_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""), std::string(doc["function_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("1e-10"),
                          std::string(doc["probability"].GetString()));
        BOOST_CHECK_EQUAL(std::string("bucketTime"),
                          std::string(doc["person_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["partition_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("root"), std::string(doc["level"].GetString()));
        BOOST_CHECK_EQUAL(std::string("53.72631"),
                          std::string(doc["normalized_score"].GetString()));
    }
    {
        ...
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["value_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""), std::string(doc["function_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string("1"), std::string(doc["probability"].GetString()));
        BOOST_CHECK_EQUAL(std::string("bucketTime"),
                          std::string(doc["person_field_name"].GetString()));
        BOOST_CHECK_EQUAL(std::string(""),
                          std::string(doc["partition_field_name"].GetString()));
