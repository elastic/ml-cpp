...
CppUnit::Test* CDetectionRulesJsonParserTest::suite() {
    CppUnit::TestSuite* suiteOfTests =
        new CppUnit::TestSuite("CDetectionRulesJsonParserTest");
    ...
    suiteOfTests->addTest(new CppUnit::TestCaller<CDetectionRulesJsonParserTest>(
        ...
        "testParseRulesGivenArrayContainsStrings",
    ...
    suiteOfTests->addTest(new CppUnit::TestCaller<CDetectionRulesJsonParserTest>(
        "CDetectionRulesJsonParserTest::"
        "testParseRulesGivenMissingConditionsConnective",
    ...
    suiteOfTests->addTest(new CppUnit::TestCaller<CDetectionRulesJsonParserTest>(
        "CDetectionRulesJsonParserTest::"
        "testParseRulesGivenMissingRuleConditions",
    ...
    suiteOfTests->addTest(new CppUnit::TestCaller<CDetectionRulesJsonParserTest>(
        "CDetectionRulesJsonParserTest::"
        "testParseRulesGivenMissingConditionOperator",
        &CDetectionRulesJsonParserTest::testParseRulesGivenMissingConditionOperator));
    suiteOfTests->addTest(new CppUnit::TestCaller<CDetectionRulesJsonParserTest>(
        "CDetectionRulesJsonParserTest::"
        "testParseRulesGivenInvalidConditionOperator",
    ...
    suiteOfTests->addTest(new CppUnit::TestCaller<CDetectionRulesJsonParserTest>(
        "CDetectionRulesJsonParserTest::"
        "testParseRulesGivenCategoricalMatchRule",
        &CDetectionRulesJsonParserTest::testParseRulesGivenCategoricalMatchRule));
    suiteOfTests->addTest(new CppUnit::TestCaller<CDetectionRulesJsonParserTest>(
        "CDetectionRulesJsonParserTest::"
        "testParseRulesGivenCategoricalComplementRule",
    ...
    suiteOfTests->addTest(new CppUnit::TestCaller<CDetectionRulesJsonParserTest>(
        "CDetectionRulesJsonParserTest::"
        "testParseRulesGivenOldStyleCategoricalRule",
...
void CDetectionRulesJsonParserTest::testParseRulesGivenMissingConditionOperator() {
    ...
    rulesJson += "  \"conditions\": [";
    rulesJson +=
        "    {\"type\":\"numerical_actual\", \"condition\":{\"value\":\"5\"}}";
    rulesJson += "  ]";
    rulesJson += "}";
    rulesJson += "]";
...
void CDetectionRulesJsonParserTest::testParseRulesGivenNumericalTypicalAndDiffAbsRuleWithConnectiveAnd() {
    ...
    rulesJson +=
        "    {\"type\":\"numerical_diff_abs\", \"field_name\":\"metric\", "
...
void CDetectionRulesJsonParserTest::testParseRulesGivenMultipleRules() {
    ...
    CPPUNIT_ASSERT_EQUAL(
        std::string("FILTER_RESULTS (id:foo) IF ACTUAL < 1.000000"), rules[0].print());
    CPPUNIT_ASSERT_EQUAL(
        std::string("SKIP_SAMPLING (id:42) IF ACTUAL < 2.000000"), rules[1].print());
}
