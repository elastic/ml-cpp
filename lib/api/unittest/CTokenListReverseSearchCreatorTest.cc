...
void CTokenListReverseSearchCreatorTest::testAddInOrderCommonToken(void) {
    ...
    reverseSearchCreator.addInOrderCommonToken(
        "user", true, reverseSearchPart1, reverseSearchPart2);
    reverseSearchCreator.addInOrderCommonToken(
        "logged", false, reverseSearchPart1, reverseSearchPart2);
    reverseSearchCreator.addInOrderCommonToken(
        "b=0.15+a", false, reverseSearchPart1, reverseSearchPart2);
    reverseSearchCreator.addInOrderCommonToken(
        "logged", false, reverseSearchPart1, reverseSearchPart2);
