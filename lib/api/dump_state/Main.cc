...
int main(int /*argc*/, char** /*argv*/) {
    ...
    if (!writeNormalizerState("../unittest/testfiles/state/" + version +
    ...
    persisted = persistCategorizerStateToFile("../unittest/testfiles/state/" + version +
                                              "/categorizer_state.json");
    if (!persisted) {
