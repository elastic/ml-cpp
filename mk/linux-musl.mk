...
CPPFLAGS=-isystem $(CPP_SRC_HOME)/3rd_party/include -isystem /usr/local/include -D$(OS) -DLINUX=2 -D_REENTRANT $(OPTCPPFLAGS)
CDEPFLAGS=-MM
COMP_OUT_FLAG=-o
LINK_OUT_FLAG=-o
...
XMLINCLUDES=`/usr/local/bin/xml2-config --cflags`
XMLLIBS=`/usr/local/bin/xml2-config --libs`
