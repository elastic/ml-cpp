...
TORCHINCLUDES=-I$(CPP_SRC_HOME)/3rd_party/pytorch/torch/include
TORCHCPULIB=torch_cpu.dll
TORCHLDFLAGS=LIBPATH$(CPP_SRC_HOME)/3rd_party/pytorch/build_libtorch/build/lib
C10LIB=c10.dll
