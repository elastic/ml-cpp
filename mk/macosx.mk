...
VALGRIND_CMD=valgrind --tool=memcheck --xml=yes --xml-file=valgrind.xml --leak-check=full --leak-resolution=med --track-origins=yes --trace-children=yes --vgdb=no $(VALGRIND_SUPPRESSIONS)
