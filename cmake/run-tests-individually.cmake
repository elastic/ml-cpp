...
#
# This script runs a SINGLE test suite per invocation and is intended for
# local development (e.g. re-running just the API tests). For CI, use
# run-all-tests-parallel.cmake instead — it discovers all suites and
# schedules them in a single CTest pool for better CPU utilisation.
#
...
#   BOOST_TEST_MAX_ARGS   - max test cases per batch (default: 2)
...
foreach(_batch IN LISTS _batches)
  # Join batch entries with ":" for Boost.Test --run_test= syntax
