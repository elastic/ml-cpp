...
#define UNIFORM_SAMPLE(TYPE)                                                         \
    ...
    static void uniformSample(CPRNG::CXorOShiro128Plus &rng,                             \
                              TYPE a, TYPE b, std::size_t n, std::vector<TYPE> &result); \
...
#undef UNIFORM_SAMPLE
        ...
        //! Get a normal sample with mean and variance \p mean and
        //! \p variance, respectively.
        static double normalSample(CPRNG::CXorOShiro128Plus &rng,
                                   double mean,
                                   double variance);

        //! Get a normal sample with mean and variance \p mean and
        //! \p variance, respectively.
        static double normalSample(CPRNG::CXorShift1024Mult &rng,
                                   double mean,
                                   double variance);
