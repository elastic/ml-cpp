...
#ifndef INCLUDED_ml_maths_common_CStatisticalTests_h
#define INCLUDED_ml_maths_common_CStatisticalTests_h
...
#endif // INCLUDED_ml_maths_common_CStatisticalTests_h
