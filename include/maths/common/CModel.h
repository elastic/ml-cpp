...
public:
    ...
    virtual void modelCorrelations(time_series::CTimeSeriesCorrelations& model) = 0;
    ...
    virtual bool probability(const CModelProbabilityParams& params,
                             ...
                             common::SModelProbabilityResult& result) const = 0;
...
public:
    ...
    //! No-op.
    void modelCorrelations(time_series::CTimeSeriesCorrelations& model) override;
...
#endif // INCLUDED_ml_maths_common_CModel_h
