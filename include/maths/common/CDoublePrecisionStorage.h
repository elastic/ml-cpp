 ...
 * limitation.
 */
#ifndef INCLUDED_ml_maths_common_CDoublePrecisionStorage_h
#define INCLUDED_ml_maths_common_CDoublePrecisionStorage_h
...
#endif // INCLUDED_ml_maths_common_CDoublePrecisionStorage_h
