...
#ifndef INCLUDED_ml_maths_common_CMixtureDistribution_h
#define INCLUDED_ml_maths_common_CMixtureDistribution_h
...
#endif // INCLUDED_ml_maths_common_CMixtureDistribution_h
