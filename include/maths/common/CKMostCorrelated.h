...
#ifndef INCLUDED_ml_maths_common_CKMostCorrelated_h
#define INCLUDED_ml_maths_common_CKMostCorrelated_h
...
public:
    ...
    using TVector = CVectorNx1<maths::common::CFloatStorage, NUMBER_PROJECTIONS>;
...
#endif // INCLUDED_ml_maths_common_CKMostCorrelated_h
