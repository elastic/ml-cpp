...
#ifndef INCLUDED_ml_maths_common_t_MathsTypes_h
...
using TSeasonalComponentVec = std::vector<maths::time_series::CSeasonalComponent>;
using TCalendarComponentVec = std::vector<maths::time_series::CCalendarComponent>;
...
#endif // INCLUDED_ml_maths_common_t_MathsTypes_h
