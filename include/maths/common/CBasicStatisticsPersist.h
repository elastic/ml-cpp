...
#ifndef INCLUDED_ml_maths_common_CBasicStatisticsPersist_h
#define INCLUDED_ml_maths_common_CBasicStatisticsPersist_h
...
#endif // INCLUDED_ml_maths_common_CBasicStatisticsPersist_h
