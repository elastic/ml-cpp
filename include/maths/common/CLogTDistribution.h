...
#ifndef INCLUDED_ml_maths_common_CLogTDistribution_h
#define INCLUDED_ml_maths_common_CLogTDistribution_h
...
#endif // INCLUDED_ml_maths_common_CLogTDistribution_h
