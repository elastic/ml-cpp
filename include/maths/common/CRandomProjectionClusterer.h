...
#ifndef INCLUDED_ml_maths_common_CRandomProjectionClusterer_h
#define INCLUDED_ml_maths_common_CRandomProjectionClusterer_h
...
protected:
    ...
    double logDeterminant(const TSvdNxN& svd) const {
        double result = 0.0;
        for (std::size_t i = 0u, rank = static_cast<std::size_t>(svd.rank());
             i < rank; ++i) {
...
#endif // INCLUDED_ml_maths_common_CRandomProjectionClusterer_h
