...
#ifndef INCLUDED_ml_maths_common_CMultivariateOneOfNPriorFactory_h
#define INCLUDED_ml_maths_common_CMultivariateOneOfNPriorFactory_h
...
class MATHS_COMMON_EXPORT CMultivariateOneOfNPriorFactory {
public:
...
#endif // INCLUDED_ml_maths_common_CMultivariateOneOfNPriorFactory_h
