...
#ifndef INCLUDED_ml_maths_time_series_CSeasonalTime_h
#define INCLUDED_ml_maths_time_series_CSeasonalTime_h
...
#endif // INCLUDED_ml_maths_time_series_CSeasonalTime_h
