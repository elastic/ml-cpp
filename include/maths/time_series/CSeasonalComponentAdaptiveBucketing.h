...
public:
    ...
    using TRegression = common::CLeastSquaresOnlineRegression<1, common::CFloatStorage>;
...
private:
    ...
    struct SBucket {
        ...
        common::CFloatStorage s_Variance;
...
#endif // INCLUDED_ml_maths_time_series_CSeasonalComponentAdaptiveBucketing_h
