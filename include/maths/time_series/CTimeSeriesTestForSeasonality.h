...
private:
    ...
    struct SHypothesisStats {
        ...
        common::CFuzzyTruthValue
        varianceTestResult(const CTimeSeriesTestForSeasonality& params) const;
        //! Test the amplitude of this hypothesis.
        common::CFuzzyTruthValue
        amplitudeTestResult(const CTimeSeriesTestForSeasonality& params) const;
        ...
        common::CFuzzyTruthValue s_Truth = common::CFuzzyTruthValue::FALSE_VALUE;
...
#endif //INCLUDED_ml_maths_time_series_CTimeSeriesTestForSeasonality_h
