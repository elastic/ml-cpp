          ...
          boost::partially_ordered<
              ...
              boost::addable<CSymmetricMatrixNxN<T, N>,
                             boost::subtractable<CSymmetricMatrixNxN<T, N>,
                                                 boost::multipliable<CSymmetricMatrixNxN<T, N>, boost::multipliable2<CSymmetricMatrixNxN<T, N>, T, boost::dividable2<CSymmetricMatrixNxN<T, N>, T>>>>>>>,
    ...
    : private boost::equality_comparable<
          ...
          boost::partially_ordered<
              ...
              boost::addable<CSymmetricMatrix<T>,
                             boost::subtractable<CSymmetricMatrix<T>, boost::multipliable<CSymmetricMatrix<T>, boost::multipliable2<CSymmetricMatrix<T>, T, boost::dividable2<CSymmetricMatrix<T>, T>>>>>>>,
    ...
    : private boost::equality_comparable<
          ...
          boost::partially_ordered<
              ...
              boost::addable<CVectorNx1<T, N>,
                             boost::subtractable<CVectorNx1<T, N>, boost::multipliable<CVectorNx1<T, N>, boost::multipliable2<CVectorNx1<T, N>, T, boost::dividable<CVectorNx1<T, N>, boost::dividable2<CVectorNx1<T, N>, T>>>>>>>>,
...
class CVector
    : private boost::equality_comparable<
          ...
          boost::partially_ordered<
              CVector<T>,
              boost::addable<CVector<T>, boost::subtractable<CVector<T>, boost::multipliable<CVector<T>, boost::multipliable2<CVector<T>, T, boost::dividable<CVector<T>, boost::dividable2<CVector<T>, T>>>>>>>>,
