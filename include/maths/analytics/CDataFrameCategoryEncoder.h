...
#ifndef INCLUDED_ml_maths_analytics_CDataFrameCategoryEncoder_h
#define INCLUDED_ml_maths_analytics_CDataFrameCategoryEncoder_h
...
public:
    ...
    common::CFloatStorage operator[](std::size_t encodedColumnIndex) const;
...
#endif // INCLUDED_ml_maths_analytics_CDataFrameCategoryEncoder_h
