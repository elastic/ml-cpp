 ...
 * limitation.
 */
#ifndef INCLUDED_ml_maths_analytics_ImportExport_h
#define INCLUDED_ml_maths_analytics_ImportExport_h
...
#ifdef BUILDING_libMlMathsAnalytics
// We're building the maths analytics library
#define MATHS_ANALYTICS_EXPORT __declspec(dllexport)
#else
// We're building some code other than the maths analytics library
#define MATHS_ANALYTICS_EXPORT __declspec(dllimport)
#endif

#else

// Empty string on Unix
#define MATHS_ANALYTICS_EXPORT

#endif

#endif // INCLUDED_ml_maths_analytics_ImportExport_h
