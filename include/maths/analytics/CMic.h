...
#ifndef INCLUDED_ml_maths_analytics_CMic_h
#define INCLUDED_ml_maths_analytics_CMic_h
...
class MATHS_ANALYTICS_EXPORT CMic final : private boost::addable<CMic> {
public:
...
private:
    ...
    using TVector2d = common::CVectorNx1<double, 2>;
    using TVector2dVec = std::vector<TVector2d>;
    using TVectorXd = common::CVector<double>;
...
#endif // INCLUDED_ml_maths_analytics_CMic_h
