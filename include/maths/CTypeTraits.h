...
{
    using Type = Eigen::Matrix<SCALAR, Eigen::Dynamic, Eigen::Dynamic, OPTIONS, Eigen::Dynamic, Eigen::Dynamic>;
};
...
{
    using Type = Eigen::ArrayWrapper<const Eigen::Matrix<SCALAR, ROWS, COLS, OPTIONS, MAX_ROWS, MAX_COLS>>;
};
