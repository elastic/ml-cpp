...
public:
    ...
    bool operator()(const SDistributionRestoreParams &params,
        ...
        return this->operator()(
            params, CClustererTypes::CDoNothing(), CClustererTypes::CDoNothing(), ptr, traverser);
    }
    ...
    bool operator()(const SDistributionRestoreParams &params,
        ...
        do {
            ...
            if (name == CClustererTypes::X_MEANS_ONLINE_TAG) {
                ptr.reset(
                    CXMeansOnlineFactory::restore<T, N>(params, splitFunc, mergeFunc, traverser));
                ++numResults;
            } else {
