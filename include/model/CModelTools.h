    ...
    public:
        ...
        class MODEL_EXPORT CFuzzyDeduplicate
        {
            public:
                ...
                void computeEpsilons(core_t::TTime bucketLength,
        ...
        class MODEL_EXPORT CProbabilityCache
        {
            ...
            public:
                ...
                void addModes(model_t::EFeature feature, std::size_t id,
                ...
                void addProbability(model_t::EFeature feature, std::size_t id,
                ...
                bool lookup(model_t::EFeature feature, std::size_t id,
                            const TDouble2Vec1Vec &value,
